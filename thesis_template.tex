...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{figures/trust_management_architecture_concept.png}
...
\begin{enumerate}
  ...
  \item \textbf{Zajem podatkov iz plasti znanja}\newline
    ...
    \begin{itemize}
      \item ontološki podatki prek strežnika Fuseki (SPARQL ali lokalni OWL),
