...
Obstoječi sistemi za upravljanje zaupanja pogosto temeljijo na delno centraliziranih podatkovnih virih, ročnih revizijah ali statičnih ocenah \cite{us2013dscsa, uddin2021blockchain}. Te pa dejanskega obnašanja akterjev ne odražajo dovolj hitro. Takšni pristopi omejujejo sposobnost regulatorjev in podjetij, da prepoznajo tveganja, ki izhajajo iz sprememb v kakovosti ali skladnosti delovanja. V literaturi so predlagani različni koncepti, ki vključujejo semantično modeliranje, decentralizirane sisteme, kriptografsko preverjanje ter obdelavo telemetrij \cite{uddin2021blockchain}, manjka pa splošna zasnova modela, ki bi te elemente povezala v enoten in razširljiv okvir za dinamično ocenjevanje zaupanja.
...
V nadaljevanju naloge najprej predstavimo teoretično ozadje upravljanja zaupanja v razpršenih sistemih ter izzive, značilne za farmacevtske dobavne verige. Nadaljujemo z opisom konceptualnega modela zaupanja in arhitekture sistema, ki omogoča izračun in usklajevanje ocene zaupanja. Sledi poglavje implementacije, kjer opišemo celotno zasnovo sistema. V poglavju evalvacije opišemo eksperimentalne scenarije, ki prikazujejo praktično delovanje sistema in z modelom groženj predstavimo ključne varnostne lastnosti sistema. V zaključku povzamemo ugotovitve in predstavimo smernice za nadaljnjo nadgradnjo rešitve.
...
ročne revizije, digitalna potrdila, agencije &
...
\subsection{Kriptografski mehanizmi v implementaciji}

Pomembne funkcije, ki jih uporabljamo v našem sistemu, temlejijo na kriptografskih mehanizmih za zagotavljanje integriteto in preverljivost podatkov. Spodaj sta opisani dve glavni funkciji: digitalno podpisovanje poročil in preverjanje teh podpisov.
