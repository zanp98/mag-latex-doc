...
\begin{itemize}
  ...
  \item implementirati prototipni sistem na testnem Ethereum omrežju s tremi oraklji, ki utelešajo različne pristope k upravljanju zaupanja,
...
Na konceptualni ravni naloga predstavi model grafa zaupanja, v katerem so semantični opisi akterjev, politik in dokazov povezani z on-chain zapisom odločitev. Na arhitekturni ravni naloga združi ontologijo, preverljive poverilnice, decentralizirano omrežje orakljev in pametno pogodbo \texttt{TrustGraph.sol} v delujoč prototip. Na implementacijski ravni naloga prikaže, kako lahko trije oraklji z različnimi algoritmi izračunajo ocene zaupanja, jih pošljejo agregatorju in preko njega zapišejo agregirano odločitev na verigo blokov. Varnostna analiza na koncu osvetli ključne grožnje in obstoječe protiukrepe ter nakaže, kaj bi bilo potrebno nadgraditi pri prehodu v realno okolje.
...
\section{Omejitve in nadaljnje delo}
