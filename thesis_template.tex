...
Kot je razvidno iz tabele~\ref{tab:oracle-concepts}, oraklji uporabljajo različne vire podatkov. Orakelj~A pri izračunu zaupanja kombinira ontologijo, preverljiva dokazila in telemetrijo, orakelj~B bere iz baze preverljivih poverilnic, orakelj~C pa ima na voljo svoj vir telemetrijskih podakov.


\begin{table}[ht]
  \centering
  \caption{Primerjava treh orakljev glede na uporabljen vir podatkov}
  \label{tab:oracle-concepts}
  \small
  \begin{tabular}{lccc}
    \hline
                    & Orakelj A & Orakelj B & Orakelj C \\
    \hline
    Ontologija      & \cmark    & \xmark    & \xmark    \\
    Preverljive poverilnice
                    & \cmark    & \cmark    & \xmark    \\
    Telemetrija     & \cmark    & \xmark    & \cmark    \\
    \hline
  \end{tabular}


  \vspace{0.3em}
  {\footnotesize \cmark{} primarni vir, \xmark{} sekundarni ali neuporabljen vir.}
\end{table}
