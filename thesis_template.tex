...
\hyphenation{trans-pa-rent-nost}
%----------------------------------------------------------------
% |||||||||||||||||||||| USTREZNO POPRAVI |||||||||||||||||||||||
% |||||||||||||||||||||| EDIT ACCORDINGLY |||||||||||||||||||||||
%----------------------------------------------------------------
...
\newcommand{\tkeywords}{upravljanje zaupanja, tehnologija veriženja blokov, dobavna veriga zdravil, ontologija, decentralizirano omrežje orakljev}
\newcommand{\tkeywordsEn}{trust management, blockchain, pharmaceutical supply chain, ontology, decentralized oracle network}
...
Farmacevtske dobavne verige sodijo med najbolj regulirana in podatkovno zahtevna okolja v sodobni industriji. Zdravila, cepiva in drugi farmacevtski proizvodi potujejo med številnimi akterji, kot so proizvajalci, distributerji, transporterji, regulatorji in zdravstvene ustanove. Od vseh se pričakuje visoka stopnja zanesljivosti in skladnosti, vendar so tovrstne verige kljub temu izpostavljene številnim tveganjem. Pogosti so primeri ponarejenih zdravil, nepravilno ravnanje z izdelki, nepopolna poročila ter pomanjkanje transparentnosti \cite{world2024global}. V veliki meri ti problemi izhajajo iz nezmožnosti pravočasnega, jasnega in doslednega preverjanja zaupanja v posamezne akterje \cite{kayhan2022ensuring}.

Obstoječi sistemi za upravljanje zaupanja v farmacevtskih dobavnih verigah pogosto temeljijo na delno centraliziranih podatkovnih virih, ročnih revizijah ali statičnih ocenah \cite{eu-161-2016, eu-62-2011, us2013dscsa}. V literaturi so bili predlagani različni pristopi za izboljšanje teh mehanizmov, vključno z reputacijskimi modeli zaupanja \cite{josang2002beta}, semantičnim modeliranjem \cite{artz2007survey}, uporabo verige blokov za zagotavljanje sledljivosti \cite{kochovski2024drug} ter integracijo podatkov iz senzorjev in zunanjih virov \cite{uddin2021blockchain}. Kljub temu večina obstoječih rešitev obravnava posamezne vidike problema ločeno in ne ponuja splošne zasnove, ki bi te elemente povezala v enoten, razširljiv in razložljiv okvir za dinamično ocenjevanje zaupanja.

V magistrski nalogi se zato osredotočamo na vprašanje, kako v farmacevtski dobavni verigi oblikovati model in mehanizem, ki omogoča transparentno, preverljivo in razširljivo upravljanje zaupanja med akterji, ne da bi bilo treba razkrivati občutljive operativne ali poslovne podatke.
...
Hipoteza naloge je, da je mogoče tak prototip zasnovati tako, da demonstrira izvedljivost decentraliziranega sistema za izračun zaupanja ter hkrati ohrani lastnosti, ki so ključne za regulativno okolje: razložljivost postopkov, razširljivost arhitekture, odpornost na posamične okvare ter minimizacijo razkritja podatkov.

Predlagani sistem temelji na kombinaciji semantičnega modeliranja, decentralizirane infrastrukture in preverljivih poverilnic. Akterji v dobavni verigi so formalno opisani z uporabo ontologije, ki omogoča predstavitev njihovih lastnosti. Zaupanje se ocenjuje na podlagi več neodvisnih virov z uporabo orakljev, ki izračune izvajajo zunaj verige blokov, končni rezultati pa se zapisujejo na verigo blokov.

V nadaljevanju naloge najprej predstavimo teoretično ozadje upravljanja zaupanja v porazdeljenih sistemih ter obstoječe pristope, uporabljene v farmacevtskih dobavnih verigah. Nato opišemo konceptualni model zaupanja in arhitekturo predlaganega sistema, vključno z vlogo ontologije, orakljev in verige blokov. Sledi poglavje implementacije, kjer podrobno predstavimo zasnovo in delovanje prototipa. V poglavju evalvacije prikažemo eksperimentalne scenarije, ki demonstrirajo praktično delovanje sistema, ter analiziramo njegove varnostne lastnosti z uporabo modela groženj. V zaključku povzamemo ključne ugotovitve in predlagamo možnosti za nadaljnji razvoj rešitve.

\chapter{Pregled literature in ozadje}
\label{ch:background}
To poglavje raziskuje koncepte, na katerih temelji sistem, razvit v okviru magistrske naloge. Začnemo z razumevanjem zaupanja in njegovih lastnosti ter s pregledom pristopov, ki se v porazdeljenih sistemih uporabljajo za njegovo modeliranje in ocenjevanje. V nadaljevanju se posvetimo farmacevtskim dobavnim verigam, kjer izpostavimo ključne težave, ki se pojavljajo pri zagotavljanju sledljivosti, varnosti in sodelovanja med akterji. Tu omenimo obstoječe rešitve, ki se že uporabljajo v praksi in predstavimo probleme, ki jih te rešitve imajo. Sledi pregled tehnologije veriženja blokov, pametnih pogodb in orakljev, ki danes predstavljajo pomemben del modernih decentraliziranih arhitektur. Poglavje zaključimo s predstavitvijo semantičnega spleta in metod, ki so potrebne za formalno opisovanje akterjev in njihovih lastnosti. Ta poglavja skupaj strnemo v množico, v kateri lahko prepoznamo vrzeli obstoječih pristopov in pripravimo teren za rešitev, ki jo predstavimo v nadaljevanju naloge.

\section{Zaupanje}

Pojem zaupanja je temeljni gradnik pri zasnovi našega sistema za farmacevtsko dobavno verigo. Zaupanje je kompleksen, večdimenzionalen in interdisciplinaren koncept, ki ga obravnavajo različne vede. Obravnava se v sociologiji, psihologiji, ekonomiji, računalništvu in še ostalih vedah. Prav zaradi te raznolikosti v literaturi ne obstaja enotna definicija, temveč več pristopov, ki poudarjajo različne vidike \cite{yan2008trust,grandison2000survey}.

\subsection{Definicije zaupanja}
V družboslovnem kontekstu je zaupanje pogosto opredeljeno kot stanje pozitivnih pričakovanj glede dejanj druge osebe v okoliščinah, kjer obstaja določena stopnja tveganja \cite{boon1991interpersonal}. Gambetta zaupanje definira kot subjektivno verjetnost, da bo akter opravil določeno dejanje, še preden je to mogoče preveriti \cite{gambetta1988trust}. Mayer, Davis in Schoorman pa ga opredelijo kot pripravljenost ene stranke, da se izpostavi ranljivosti glede na dejanja druge stranke, ob pričakovanju, da bo ta delovala v skladu s pričakovanji \cite{mayer1995integrative}.

V digitalnem okolju se koncept zaupanja prenaša iz družbenega v tehnični kontekst. Denning trdi, da je zaupanje v sistem lastnost, ki jo je mogoče formalno določiti in jo modelirati \cite{denning1993trust}. Sistem je torej zaupanja vreden, če mu njegovi uporabniki zaupajo glede na opaženo skladnost z vnaprej določenimi standardi. Grandison in Sloman zaupanje obravnavata kot kvalificirano prepričanje zaupnika o kompetentnosti, integriteti, varnosti in zanesljivosti zaupanja vrednega subjekta \cite{grandison2000survey}.

\subsection{Lastnosti zaupanja}

Zaupanje je po svoji naravi večdimenzionalen pojem, ki ga ni mogoče zajeti z eno samo definicijo. V literaturi se ponavlja, da zaupanje vključuje čustvene in vedenjske komponente, ki se med seboj prepletajo in vplivajo na odločanje posameznika ali sistema \cite{mcknight2001trust, karthik2017ontology}. V družbenem kontekstu gre za pripravljenost posameznika, da se izpostavi tveganju na podlagi prepričanja, da bo druga stran delovala predvidljivo in skladno s pričakovanji. V informacijskih sistemih pa to pomeni sposobnost sistema, da sprejema odločitve o sodelovanju na podlagi preteklih izkušenj in ocenjene zanesljivosti entitet. V tej nalogi izraz \emph{entiteta} uporabljamo kot splošni pojem za udeležene subjekte v sistemu, pri čemer so v obravnavanem kontekstu to praviloma \emph{akterji} dobavne verige.

Zaupanje obstaja le v razmerju med dvema ali več entitetami, kjer ena zaupa drugi v določeni situaciji ali kontekstu. Takšno razmerje je dinamično, saj se lahko stopnja zaupanja s časom povečuje ali zmanjšuje. Poleg tega je zaupanje asimetrično: dejstvo, da entiteta A zaupa entiteti B, še ne pomeni, da bo tudi B zaupala A \cite{mayer1995integrative}.

Ena od osrednjih značilnosti zaupanja je njegova povezanost s tveganjem in negotovostjo. Zaupanje je smiselno le v okoliščinah, kjer obstaja možnost, da drugi akter ne bo ravnal skladno s pričakovanji \cite{boon1991interpersonal}. Če bi imeli popoln nadzor ali vse informacije, zaupanje sploh ne bi bilo potrebno. V kontekstu varnostnih in distribucijskih sistemov zaupanje dopolnjuje formalne zaščitne mehanizme, kot so avtentikacija in šifriranje, saj omogoča oceno vedenja akterjev tam, kjer tehnični ukrepi ne zadostujejo \cite{denning1993trust}.
...
Klasični modeli, kot sta predstavljena v delih avtorjev Mayer, Davis in Schoorman \cite{mayer1995integrative} ter McKnight in Chervany \cite{mcknight2001trust}, opredeljujejo tri temeljne dimenzije zaupanja, ki jih slednja avtorja klasificirata kot prepričanja o lastnostih partnerja: kompetentnost, dobrohotnost in integriteta.
Kompetentnost (angl. \textit{Competence}) poleg usposobljenosti opraviti nekaj, pomeni zlasti prepričanje, da ima entiteta zmožnosti in vire za učinkovito izvedbo nalog, ki so zanjo pričakovane. Dobrohotnost (angl. \textit{Benevolence}) izraža prepričanje, da druga stran pri svojem delovanju upošteva interese uporabnika in ne deluje oportunistično. Integriteta (angl. \textit{Integrity}) oziroma načelnost pa se nanaša na zaznano moralno držo subjekta, ki vključuje spoštovanje dogovorov in dosledno izpolnjevanje obljub. Tem trem dimenzijam se v številnih delih pridružuje še predvidljivost (angl. \textit{Predictability}), ki temelji na konsistentnosti preteklih ravnanj in omogoča sklepanje o prihodnjem vedenju entitete v podobnih okoliščinah.

V digitalnih in porazdeljenih okoljih so se pojavili dodatni atributi, ki izhajajo iz tehničnih vidikov zaupanja. Grandison in Sloman zaupanje opišeta kot prepričanje o pristojnosti, varnosti in verodostojnosti drugega subjekta \cite{grandison2000survey}. Denning poudarja, da je zaupanje sistema mogoče ocenjevati tudi z vidika varnosti, skladnosti s pravili ter preverljivostjo delovanja \cite{denning1993trust}. Ti atributi omogočajo formalno ocenjevanje zaupanja med akterji.

V kontekstu farmacevtskih dobavnih verig imajo atributi zaupanja izrazito regulatorno in sledilno komponento. Uddin in sodelavci \cite{uddin2021blockchain} poudarjajo, da so pri zagotavljanju zaupanja ključni kazalniki sledljivost, pristnost in celovitost podatkov.
...
Predstavljeni atributi ne predstavljajo univerzalne množice meril, temveč zbirko značilnosti, ki jih lahko posamezen akter uporabi pri lastni presoji zaupanja. V sistemu, ki je predstavljen v tej nalogi, se atributi uporabljajo predvsem kot podatkovne lastnosti v ontologiji. Te omogočajo, da akterji formalno zapišejo svoje kriterije za ocenjevanje drugih entitet. S tem v sistemu omogočamo standardizirano predstavitev vhodnih meril, ki jih posamezni akterji uporabljajo pri svojem algoritmu za izračunavanje zaupanja.

\newpage
\subsection{Modeliranje zaupanja v računalniških sistemih}
\label{subsec:modeliranje-zaupanja}

Modeliranje zaupanja v računalniških sistemih presega zgolj definicije in atribute, saj zahteva preslikavo subjektivnih konceptov v algoritme, ki morajo avtonomno odločati o tem, ali subjektu zaupajo ali ne. Modeli zaupanja določajo mehanizme za zbiranje, agregacijo in uporabo lastnosti ter atributov zaupanja pri izračunu končne vrednosti. Osnovni cilj modeliranja je podpora pri odločanju v pogojih negotovosti, kjer se ocenjevalec odloča o interakciji z drugo entiteto.

Cho in sodelavci v članku \textit{A Survey on Trust Modeling} \cite{cho2015survey} proces ocenjevanja zaupanja opisujejo kot dinamično in ponavljajočo se zanko, ki se začne z zbiranjem dokazov o preteklem vedenju, priporočil drugih ali neposrednih interakcijah. Temu sledi faza analize, kjer algoritem izračuna stopnjo zaupanja in oceni tveganje glede na ranljivost sistema ter potencialni vpliv negativnega izida. Na podlagi te ocene in določenega praga tolerance se akter odloči ali se strinja s sodelovanjem. Po končani interakciji sistem zabeleži izid, ki služi kot povratna informacija in nov dokaz za posodobitev ocene zaupanja v prihodnjih ciklih.

Zaradi heterogenosti sodobnih omrežij enodimenzionalni modeli pogosto ne zadoščajo, avtorji predlagajo koncept sestavljenega zaupanja. Ta pristop združuje štiri medsebojno povezane dimenzije: (i) komunikacijsko zaupanje, ki se nanaša na zanesljivost omrežja in kakovost storitve; (ii) informacijsko zaupanje, ki ocenjuje verodostojnost in celovitost podatkov; (iii) družbeno zaupanje, ki izhaja iz odnosov in ugleda v socialni strukturi; ter (iv) kognitivno zaupanje, ki modelira subjektivna pričakovanja in nagnjenost akterja k tveganju.

Modeli se razlikujejo tudi po načinu ocenjevanja zaupanja, ki neposredno vpliva na zmožnost sistema za odločanje. Vrednosti se lahko merijo na številski lestvici, na primer kot verjetnost med 0 in 1, ali pa na diskretni lestvici z opisnimi stopnjami zaupanja. Izbira ustreznih metril in modela zahteva iskanje ravnovesja med natančnostjo ocene in računsko zahtevnostjo, kar je posebej pomembno pri implementaciji v realnem času na napravah z omejenimi viri \cite{cho2015survey}.

\section{Upravljanje zaupanja v porazdeljenih sistemih}
\label{sec:trust-management-distributed-systems}
Huaizhi Li in Mukesh Singhal v članku \textit{Trust Management in Distributed Systems} \cite{li2007survey} opredelita upravljanje zaupanja kot proces zbiranja informacij, potrebnih za vzpostavitev zaupanja med entitetami, kot tudi dinamičnega spremljanja in prilagajanja obstoječih razmerij zaupanja. Avtorja poudarjata, da v porazdeljenih okoljih kot so internet, sistemi enakovrednih entitet (angl. \textit{peer-to-peer networks}) in mobilna omrežja ad hoc pogosto sodelujejo entitete, ki se med seboj ne poznajo. Zato zaupanje postane ključni mehanizem za zmanjšanje tveganja in zagotavljanje sodelovanja. Namen sistema za upravljanje zaupanja je ohranjati ažurne in usklajene informacije o zaupanju med akterji v omrežju. V naslednjih podpoglavjih povzemamo različne pristope k upravljanju zaupanja, ki so jih avtorji predstavili v svojem pregledu literature. V sistemu, razvitem v sklopu magistrske naloge ti pristopi in enačbe niso predpisani. Služijo kot možne izbire za izračunavanje zaupanja za posamezne akterje.

\subsection{Dokazni modeli zaupanja}
\label{sub:evidence-trust-models}
Pri dokaznih modelih zaupanja se zaupanje ne gradi na preteklih interakcijah ali priporočilih, temveč na preverjanju formalnih dokazil, ki potrjujejo identiteto ali lastnosti entitet.

Eschenauer in sodelavci predstavijo ogrodje za upravljanje zaupanja v omrežjih ad hoc, ki temelji na preverjanju dokazil \cite{eschenauer2002trust}. Zaupanje obravnavajo kot množico odnosov, vzpostavljenih na podlagi dokazil. Ta so lahko karkoli, kar zahteva politika za vzpostavitev zaupanja. Po navadi so to javni ključi, naslovi ali identitete. Vsaka entiteta lahko ustvari dokazilo zase ali za druge entitete.
...
Vsaka entiteta ocenjuje druge glede na pretekle interakcije, te ocene pa se lahko prenašajo naprej kot priporočila.
Model uporablja pogojno tranzitivnost zaupanja – entiteta $A$ lahko zaupa entiteti $C$, če zaupa entiteti $B$ kot priporočitelju in lahko ovrednoti kakovost njegovih priporočil.

Abdul-Rahman in Hailes predlagata porazdeljeni model zaupanja, ki temelji na izračunu zaupanja iz verig priporočil med akterji \cite{abdul1998distributed}.
Vsak akter hrani diskretne vrednosti zaupanja na lestvici od $-1$ do $4$, kjer $-1$ pomeni popolno nezaupanje, $0$ nevednost (akter si ne upa podati ocene), vrednosti $1$ do $3$ označujejo naraščajoče stopnje zaupanja, $4$ pa predstavlja popolno zaupanje.
Ločita med:
\begin{itemize}
  \item \emph{vrednostjo priporočiteljevega zaupanja} $\mbox{tv}(R_i)$, ki opisuje, koliko akter zaupa $i$-temu priporočitelju na poti in
  \item \emph{priporočeno vrednostjo zaupanja} $\mbox{rtv}(T)$, ki jo o ciljni entiteti $T$ poda zadnji priporočitelj v verigi.
\end{itemize}
Naj bo $n$ število priporočiteljev, $R_1, R_2, \dots, R_n$ pa zaporedni priporočitelji na poti od izvornega priporočitelja do tistega, ki priporočilo zahteva.
Zaupanje v ciljno entiteto $T$ po poti $p$ označimo z $\mbox{tv}_p(T)$.
Avtorja predlagata naslednjo formulo za izračun zaupanja po poti $p$ \cite{abdul1998distributed}:
\begin{equation}
  \mbox{tv}_p(T) = \left( \prod_{i=1}^{n} \frac{\mbox{tv}(R_i)}{4} \right) \cdot \mbox{rtv}(T).
  \label{eq:abdulrahman-path}
\end{equation}
Ker lahko akter za isto ciljno entiteto $T$ prejme več priporočil po različnih poteh, naj bo $r$ število teh poti, označenih z $i = 1, \dots, r$. Vse delne ocene zaupanja $\mbox{tv}_1(T), \dots, \mbox{tv}_r(T)$ se povprečijo, tako da se končna priporočilna ocena zaupanja v entiteto $T$ izračuna kot
$\mbox{tv}(T) = \frac{1}{r} \sum_{i=1}^{r} \mbox{tv}_i(T)$ \cite{abdul1998distributed}.

\subsection{Porazdeljeno ocenjevanje zaupanja}

V omrežjih enakovrednih akterjev (P2P) se zaupanje ocenjuje na decentraliziran način. Vsako vozlišče vodi lastno evidenco interakcij in vrednoti druge glede na uspešnost sodelovanja. Xiong in Liu v okviru sistema PeerTrust predlagata merilo, ki zaupanje akterja $u$ izrazi kot razmerje med združenimi ocenami zadovoljstva drugih z njegovimi storitvami in skupnim številom interakcij \cite{xiong2002building}.

Naj bo $P$ množica vseh vozlišč v omrežju, $u \in P$ opazovani akter, $v \in P$ ($v \neq u$) preostala vozlišča, $t$ pa številka transakcije. Funkcije so definirane tako:
\begin{itemize}
  \item $I(u,v,t)$ je število interakcij med $u$ in $v$ do transakcije $t$,
  \item $S(u,v,t)$ je število interakcij vozlišča $v$ z akterjem $u$ do transakcije $t$, kjer ni prišlo do pritožb, 
  \item $\mbox{Cr}(v,t) \in [0,1]$ je faktor uravnoteženja zaupanja, ki zmanjšuje tveganje neverodostojnih povratnih informacij iz vozlišča $v$.
\end{itemize}
Ocena zaupanja v akterja $u$ do časa $t$ je nato definirana kot \cite{xiong2002building}
\begin{equation}
  T(u,t) = \frac{\sum_{v \in P, v \neq u} S(u,v,t)\,\mbox{Cr}(v,t)}{\sum_{v \in P, v \neq u} I(u,v,t)}.
  \label{eq:xiong-peertrust}
\end{equation}
Vrednost $T(u,t)$ leži v intervalu $[0,1]$ in predstavlja globalno reputacijsko oceno akterja $u$ na podlagi skupnega, uteženega zadovoljstva vseh vozlišč, ki so z njim sodelovala. 

Za odločanje, ali je akter zaupanja vreden, avtorja uvedeta pragova $c_1$ in $c_2$. Prag $c_1$ določa minimalno število skupnih interakcij, ki jih mora imeti akter, da lahko opazovalec sprejme informirano odločitev. Prag $c_2$ pa izraža, kako visoko vrednost zaupanja je opazovalec pripravljen sprejeti kot še dovolj dobro: bolj toleranten akter lahko izbere nižji $c_2$, manj toleranten pa višjega. Akter $u$ se obravnava kot zaupanja vreden, če hkrati velja $I(u, v, t) > c_1$ in $T(u,t) > c_2$ \cite{xiong2002building}.

\subsection{Dinamično posodabljanje zaupanja}

Ker se vedenje akterjev sčasoma spreminja, se mora zaupanje prilagajati novim informacijam.
Posodobitev vrednosti se pogosto izvede z amortizacijskimi faktorji, ki dajejo večjo težo nedavnim interakcijam.
Primer takšnega modela predstavijo Lin in sodelavci v članku \textit{A Reputation and Trust Management Broker Framework for Web Applications} \cite{lin2005reputation}. 

Avtorji predlagajo porazdeljen sistem posrednikov zaupanja, kjer vsak posrednik vzdržuje bazo podatkov o ugledu storitev na podlagi povratnih informacij uporabnikov po opravljenih transakcijah. Ko uporabnik posreduje novo oceno $r$ za določeno storitev, posrednik posodobi shranjeno vrednost ugleda $T_{old}$ v novo vrednost $T_{new}$. Pri tem upošteva število preteklih transakcij $N$, časovno razliko ${\Delta}t$ med novo oceno in zadnjo shranjeno oceno ter parameter časovnega zastaranja $\beta$, ki določa, kako hitro starejše ocene postanejo manj pomembne. Formula za posodobitev ugleda je podana kot \cite{lin2005reputation}:
\begin{equation}
T_{\text{new}}
  = e^{-\beta \Delta t}\,\frac{N}{N+1} T_{\text{old}}
    + \left(1 - e^{-\beta \Delta t}\right)\frac{N}{N+1} r,
\end{equation}
kjer je $e^{-\beta \Delta t}$ amortizacijski faktor, ki zmanjšuje vpliv starejših ocen glede na časovno razliko ${\Delta}t$. Tako se zagotovi, da novejše ocene bolj vplivajo na ugled, kar omogoča dinamično prilagajanje zaupanja glede na trenutno vedenje akterjev.

\subsection{Povezava z našo rešitvijo}
Predstavljeni modeli in enačbe v tem poglavju služijo kot pregled možnih pristopov k izračunu zaupanja v porazdeljenih okoljih. V okviru te naloge jih obravnavamo kot primere, ki jih je mogoče uporabiti pri implementaciji izračuna v orakljih, vendar njihova uporaba ni predpisana.

Osrednji poudarek naloge je na zasnovi in implementaciji sistema, ki omogoča, da različni akterji izvedejo izračun zaupanja po lastnih pravilih in z uporabo lastnih algoritmov. Sistem zato ne vsiljuje enotnega modela, temveč zagotavlja skupen mehanizem za pridobivanje vhodnih podatkov ter za preverljiv in trajen zapis rezultatov na verigo blokov, neodvisno od izbrane metode izračuna.
...
Ti ukrepi predstavljajo pomembne korake k večji sledljivosti, vendar še vedno temeljijo na centraliziranih bazah podatkov, kjer posamezni akterji nimajo popolnega vpogleda v celotno dobavno verigo.
...
V literaturi takšnega posrednika imenujemo \emph{orakelj} \cite{caldarelli2020oracleproblem}.
...
Sledijo jim porazdeljeni oziroma decentralizirani oraklji, kjer več neodvisnih vozlišč pridobiva in združuje podatke in tako zmanjšuje tveganje za manipulacijo podatkov.
Primer takšne zasnove je sistem ASTRAEA, predlagan s strani Adlerja in sodelavcev, ki uporabi glasovalno igro z vložki in ločene vloge udeležencev (oddajalci trditev, glasovalci, certificiranci), da z ekonomsko motivacijo spodbudi udeležence k poštenemu poročanju o resničnosti trditev \cite{adler2018astraea}.
Podobno pristopajo tudi druge rešitve, kjer se omrežja orakljev, kot je Chainlink, uporabljajo za zbiranje podatkov iz več API-jev in senzorjev ter za izračun dodatnih meril (npr. reputacije) še pred zapisom na verigo blokov. Tak pristop uporabijo Kochovski in sodelavci v članku \textit{Trust management in a blockchain based fog computing platform with trustless smart oracles} \cite{kochovski2019trust}.

V okviru te naloge oraklje obravnavamo kot ločeno plast med semantičnim delom sistema in verigo blokov.
Podobno kot pri Chainlinku smo zasnovali decentralizirano omrežje pametnih orakljev, kjer se izvaja koda. Omrežje orakljev iz ontologije in pravil zaupanja prebere podatke, izvede izračun zaupanja ter rezultat posreduje pametni pogodbi.
...
\subsection{Decentralizirane identitete in preverljive poverilnice}
...
Preverljive poverilnice (angl. Verifiable Credentials - VC) so standardizirana digitalna dokazila, ki jih neka entiteta izda drugi entiteti. Model W3C sledi arhitekturi izdajatelj–imetnik–preveritelj. Izdajatelj (Issuer) ustvari in podpiše dokazilo, imetnik (Holder) ga hrani, preveritelj (Verifier) pa ga validira s kriptografskim podpisom \cite{vcdata2019}. VC omogočajo prenos lastnosti ali potrdil na način, ki je preverljiv, varen in ne potrebuje zaupanja v posrednika. Preverljivost in varnost se zagotavljata z uporabo digitalnih podpisov. Imetnik dokazilo lahko predloži komurkoli kadarkoli, brez obveščanja ali dovoljenja izdajatelja. Preveritelj lahko podpis preveri lokalno, s čimer se potrdita pristnost izdajatelja in celovitost podatkov, brez potrebe po centralnem posredniku ali sprotnem poizvedovanju pri izdajatelju \cite{mazzocca2025survey}.

V predstavljenem sistemu ima vsak akter v ontologiji lasten DID. Ta služi kot osnovni identifikator, na katerega se vežejo atributi in podatki v ontologiji. Na ta način sistem ohrani enotno identiteto akterjev med vsemi plastmi arhitekture.

Preverljive poverilnice uporabljamo za opis lastnosti, ki so pomembne za ocenjevanje zaupanja. Regulator, kot je EMA, lahko na primer izda VC, ki potrjuje veljavnost licence, certifikat GMP ali rezultat presoje kakovosti. Poverilnice so digitalno podpisane in povezane z DID akterja. Orakelj lahko med izračunom zaupanja prebere VC, preveri podpis izdajatelja ter iz podatkov izlušči merila, katera akter uporablja v svoji politiki zaupanja. Če akter v svojih pravilih določi, da mora imeti partner veljavno licenco ali ustrezno oceno presoje kakovosti, lahko te kriterije pridobi neposredno iz VC.
...
Centralizirani sistemi kakovosti (GDP \cite{ema2013gmp}/GMP \cite{who2010good}) &
ročne revizije, digitalna potrdila, regulatorji &
nizka; periodične revizije &
delna; opis revizijskih postopkov &
centralizacija, počasen odziv, pomanjkanje kriptografske sledljivosti \\
\hline

Reputacijski modeli (ocene partnerjev) \cite{josang2002beta, resnick2000reputation} &
...
Semantični modeli zaupanja \cite{artz2007survey} &
ontologije, formalna pravila, sklepanje &
srednja; ob posodobitvi virov znanja &
visoka; formalna in sledljiva razlaga &
ni vgrajenega mehanizma za integriteto podatkov na verigi  \\
\hline

Rešitve z uporabo verige blokov (blockchain) \cite{kochovski2024drug, uddin2021blockchain} &
transakcije, digitalna potrdila &
visoka; dogodki v realnem času &
srednja; preverljivost podatkov, omejena razlaga &
ne obravnavajo izračuna zaupanja; brez večnivojskih kriterijev \\
\hline

\textbf{Predstavljen sistem} &
VC, ontologija, DON &
visoka; vsak izračun sproži nove ocene &
zelo visoka; deterministični in verjetnostni del z razlagami &
odprta vprašanja upravljanja identitet, strošek implementacije \\
\hline
\end{tabularx}
\end{table}
\end{landscape}
...
V tem poglavju preidemo od konceptualnega modela k dejanski implementaciji prototipa. Na začetku opišemo tehnologije, ki smo jih uporabili. V nadaljevanju bolj podrobno orišemo arhitekturo ter njene ključne komponente. Na koncu predstavimo delovanje sistema skozi tokove podatkov in razložimo, kako so različni deli povezani v celoto. Izvorna koda prototipa, konfiguracijske datoteke in navodila za zagon so dostopni v javnem repozitoriju \cite{pizmoht2025repo}.

Na sliki~\ref{fig:architecture-concept} je prikazan koncept ciljne arhitekture sistema. Diagram ponazarja glavne gradnike: uporabnike (akterje dobavne verige), uporabniški vmesnik, plast znanja (ontologija in shramba preverljivih poverilnic), decentralizirano omrežje orakljev (DON) ter verigo blokov s pametno pogodbo, ki služi kot skupni register zaupanja. Ciljni koncept delovanja sistema je bil, da lahko uporabniki preko uporabniškega vmesnika komunicirajo s sistemom zaupanja na verigi blokov, ki črpa znanje iz ontologije in shrambe preverljivih poverilnic. Prototip, ki ga opišemo v nadaljevanju, realizira to zasnovo v testnem okolju in omogoča izvajanje ponovljivih scenarijev.
...
Pri razvoju sistema smo uporabili različna orodja in platforme, ki skupaj omogočajo obdelavo semantičnih podatkov, izvajanje izračuna zaupanja ter zapis rezultatov na verigo blokov. V tem razdelku podajamo pregled najpomembnejših tehnologij in njihovih vlog v sistemu.

\paragraph{Git in GitHub}
Za upravljanje izvorne kode prototipa smo uporabili sistem za nadzor različic Git. Z zgodovino sprememb je mogoče pregledati razvoj projekta in povrniti prejšnja stanja. Repozitorij gostuje na platformi GitHub, ki služi kot osrednje mesto za distribucijo kode in dokumentacijo. Izvorna koda prototipa je dostopna na: \url{https://github.com/zanp98/trust-management} \cite{pizmoht2025repo}.

\paragraph{Apache Jena Fuseki}
Semantični podatki o akterjih in njihovih lastnostih so shranjeni v strežniku Apache Jena Fuseki, ki predstavlja RDF podatkovno bazo z dostopom prek vmesnika SPARQL. Fuseki omogoča centralizirano hrambo ontologije in primerkov ter enoten način pridobivanja podatkov za vse oraklje. Zaradi stabilnosti, enostavne uporabe in dobre združljivosti s standardi RDF je bila izbira naravna. Sistem se izvaja v vsebniku Docker, kar omogoča hitro postavitev in ponovljivost okolja.

\paragraph{Ontologija v OWL/RDF}
Ontologija farmacevtske dobavne verige je zapisana v jeziku OWL, ki definira razrede, lastnosti in odnose med akterji. Podatki so organizirani v RDF trojkah, kar omogoča enostavno obdelavo s knjižnico \texttt{rdflib} v programskem jeziku Python. Na ta način lahko sklepanje temelji na aktualnih podatkih, zapisanih v ontologiji, brez potrebe po relacijski bazi ali ročnem povezovanju.

\paragraph{Ethereum, Solidity in pametna pogodba}
Za zapis rezultatov zaupanja smo uporabili verigo blokov Ethereum.
Pametna pogodba \texttt{TrustGraph.sol}, napisana v jeziku Solidity, hrani relacije zaupanja med akterji.
...
Razvoj in testiranje sta izvedena z orodjem Foundry, ki nudi lokalno testno omrežje, prevajalnik ter hitre skripte za izvajanje transakcij.
...
\paragraph{Decentralizirane identitete in preverljive poverilnice}
Vsak akter v ontologiji ima dodeljen decentraliziran identifikator (v nadaljevanju DID).
DID služi kot enoličen identifikator, ki povezuje podatke v ontologiji s predstavnikom akterja v decentraliziranem okolju.
Poleg tega sistem podpira uporabo preverljivih poverilnic (VC), ki jih lahko izdajajo regulatorji, kot je EMA.
Ta dokazila vsebujejo merila, kot so veljavnost licence, skladnost s standardi GMP ali rezultati presoje kakovosti.
...
Del logike sistema je implementiran v programskem jeziku Python, kjer se izvaja logika orakljev, agregatorjev ter orodij za upravljanje ontologije. Python je bil izbran zaradi že razvitih uporabnih knjižnic za obdelavo podatkov, delo z RDF in integracijo z verigami blokov. Spodaj so povzete ključne knjižnice, ki jih sistem uporablja:
...
\item{\texttt{rdflib}} omogoča delo z RDF grafi, lažje branje datotek OWL in manipulacijo ontologije.

\item{\texttt{SPARQLWrapper}} omogoča pošiljanje poizvedb SPARQL strežniku Apache Jena Fuseki in s tem branje lastnosti akterjev iz ontologije

\item{\texttt{requests}} se uporablja pri pomožnih sinhronih klicih HTTP, kjer asinhrona izvedba ni potrebna ali bi otežila implementacijo.

\item{\texttt{click}} se uporablja pri implementaciji ukaznih orodij, kot je \texttt{trustkb}, ki omogoča delo z ontologijo, uvoz podatkov in izvajanje poizvedb SPARQL iz ukazne vrstice.
...
\item{\texttt{didkit}} -- knjižnica se uporablja v primerih, kjer se preverljive poverilnice izdaja ali preverja neposredno iz Python okolja. Omogoča delo z DID metodami in verifikacijo podpisov, skladno s standardi W3C DID in VC.

\end{itemize}

\paragraph{Pametni oraklji}
Oraklji predstavljajo most med semantično plastjo in verigo blokov.
Vsak orakelj zažene Python modul, ki prebere ontologijo, uporabi pravila akterja in izračuna vrednosti zaupanja.
Nato z uporabo knjižnice \texttt{web3} pošlje transakcijo pametni pogodbi.
...
Vsak orakelj, strežnik Fuseki in lokalna veriga Ethereum se izvajajo v ločenih vsebnikih.
Docker je uporabljen izključno za potrebe testiranja med razvojem.

\subsection{Podpisovanje in preverjanje poročil orakljev}

Pomembne funkcije, ki jih uporabljamo v našem sistemu, temlejijo na kriptografskih mehanizmih za zagotavljanje integriteto in preverljivost podatkov. V nadaljevanju opišemo funkciji, ki ju uporabljamo za digitalno podpisovanje poročil (\texttt{sign\_message}) in preverjanje pristnosti podpisnika le teh (\texttt{recover\_message}). Obe funkciji v Ethereumovem okolju uporabljata algoritem digitalnega podpisa ECDSA.

ECDSA predstavlja naprednejšo različico algoritma DSA, ki za svoje delovanje uporablja matematične lastnosti eliptičnih krivulj. Glavna prednost uporabe tega pristopa namesto DSA je, da zagotavlja enako raven varnosti pri bistveno krajših dolžinah ključev. To omogoča hitrejše generiranje podpisov in manjšo porabo prostora, kar je pomembno za učinkovitost transakcij v omrežjih veriženja blokov. Ethereum uporablja eliptično krivuljo imenovano \texttt{secp256k1} \cite{secp256k1}.

Proces podpisovanja se začne z ustvarjanjem zgostitve sporočila. Podpisnik nato uporabi svoj zasebni ključ, ki ga algoritem s pomočjo operacij na eliptični krivulji pretvori v digitalni podpis. Rezultat tega postopka je podpis, sestavljen iz trojke $(v, r, s)$, ki tvori končni podpis. Funkcija \texttt{sign\_message} v našem sistemu sprejme zgostitev sporočila in zasebni ključ podpisnika ter vrne podpis, vrednosti $(v, r, s)$ in podpisano sporočilo.

Podpis preverjamo s funkcijo \texttt{recover\_message}. Ta na podlagi podpisa in zgostitve sporočila obnovi naslov podpisnika. Če se izračunani naslov ujema z znanim naslovom pošiljatelja, je pristnost sporočila potrjena.

\section{Arhitektura sistema}
\label{sec:arhitektura-sistema}
Arhitektura razvitega sistema temelji na večplastnem pristopu, ki ločuje podatkovni model, mehanizme izračuna in zapis rezultatov zaupanja. Takšna zasnova omogoča jasne meje med posameznimi odgovornostmi, kar olajša razvoj, testiranje in morebitno razširjanje sistema na druge domene. V okviru magistrske naloge smo zasnovali arhitekturo, ki je dovolj splošna, da jo je mogoče uporabiti v različnih porazdeljenih okoljih, od farmacevtskih dobavnih verig do pametnih mest.
...
V nadaljevanju poglavja predstavimo zasnovo arhitekture in posamezne plasti, prikažemo tok podatkov med njimi ter utemeljimo vlogo uporabljenih tehnologij.
...
Ko regulator ali drug akter sproži zahtevo za izračun zaupanja, pametna pogodba pošlje zahtevo omrežju orakljev. Vsak orakelj nato izvede svoj del naloge: iz ontologije in baze TrustKB pridobi podatke, po potrebi preveri pripadajoče preverljive poverilnice, nato pa izračuna rezultat zaupanja. Oraklji rezultate podpišejo in posredujejo agregatorju, ki pripravi končni konsenzni izračun in ga zapiše nazaj v pametno pogodbo.
...
\begin{enumerate}
  \item \textbf{Plast znanja (Knowledge Layer)}
        V tej plasti se nahaja ontologija dobavne verige in opisne lastnosti akterjev. Ontologija predstavlja skupni referenčni model, ki omogoča enotno interpretacijo podatkov o akterjih. Poleg ontologije se tukaj nahaja tudi skladišče preverljivih poverilnic (VC), ki dodaja podatke o licencah, certifikatih in presojah kakovosti.

  \item \textbf{Plast izračuna zaupanja (Trust Resolution Layer)}
        Oraklji v tej plasti izvajajo izračune zaupanja. Podatke pridobijo iz ontologije in preverljivih poverilnic ter jih povežejo s pravili, ki jih določi posamezen akter. Pravila so zapisana v JSON obliki in opisujejo pogoje, ki jih mora ocenjevana entiteta izpolnjevati. Oraklji izvedejo izračun, rezultat podpišejo in ga posredujejo agregatorju.
...
Plast znanja predstavlja osnovni vir informacij, na katerem poteka izračun zaupanja. Vsebuje semantični model dobavne verige zdravil, podatke o posameznih akterjih ter dodatne preverljive poverilnice, ki opisujejo regulatorne lastnosti ali skladnost z zahtevami. V tej plasti se združujejo podatki iz dveh virov: ontologije, ki opisuje akterje in njihove lastnosti ter preverljive poverilnice (VC), ki dopolnjujejo semantični model z digitalno podpisanimi trditvami. Oraklji te podatke uporabljajo pri izračunu zaupanja v nadaljnjih plasteh sistema.
...
Ontologija vsebuje tudi posamezne primerke akterjev, na primer \textit{Pfizer} ali \textit{DHL}, ki imajo pripisane konkretne vrednosti lastnosti. Spodaj je prikazan primer zapisa prevoznika v obliki RDF/Turtle:

\begin{lstlisting}[style=trustcode]
...
Ker je ontologija zgrajena v OWL, omogoča tudi uporabo sklepalnika (angl. reasoner). Sklepalnik lahko samodejno razvrsti akterje v razrede (npr. \texttt{TrustedTransporter}), zazna nedoslednosti in izpelje lastnosti, ki niso zapisane neposredno. Vsak orakelj lahko sklepalnik po potrebi zažene lokalno in s tem pridobi izpeljane podatke.

\newpage
\paragraph{Preverljive poverilnice (VC)}

Poleg podatkov iz ontologije sistem uporablja še preverljive poverilnice (VC), ki jih izdajajo regulatorji ali druge zaupanja vredne organizacije. Te vsebujejo trditve o akterjih, kot so veljavnost licence, skladnost z GMP ali datum zadnje presoje kakovosti. Zapisane so v formatu JSON-LD in digitalno podpisane.

Primer poverilnice, ki ga izda regulator:
...
Preverljive poverilnice so shranjene v ločeni podatkovni bazi. Ob izračunu zaupanja orakelj preveri kriptografski podpis izdajatelja, iz podatkov izlušči relevantne lastnosti in jih združi z informacijami iz ontologije. Tako sestavi popoln nabor kriterijev, ki jih akter uporabi pri ocenjevanju zaupanja.

Plast znanja združuje semantične opise akterjev in njihove lastnosti z regulatorno potrjenimi podatki iz preverljivih poverilnic. Oraklji pri izračunu zaupanja dostopajo do obeh virov: iz Fusekija pridobijo opisna merila, iz VC-jev pa dodatne podatke, ki jih ontologija ne vsebuje. S tem plast znanja omogoča enoten in strukturiran nabor podatkov, na katerem temelji celoten izračun zaupanja.
...
\begin{enumerate}
  ...
  \item oraklji poslušajo te dogodke, za podanega akterja preberejo podatke iz ontologije in pripadajočih preverljivih poverilnic,
...
Na ta način plast izračuna zaupanja povezuje semantične podatke z decentraliziranim zapisom rezultatov. Oraklji omogočajo neodvisno izvajanje izračunov, agregator pa poskrbi za preverjanje in enoten zapis v register zaupanja na verigi blokov. Plast torej tvori most med modelom znanja in verigo blokov ter predstavlja ključen element celotne arhitekture.
...
\begin{enumerate}
  \item \textbf{Aplikacija ali uporabnik ustvari zahtevo}\newline
    Uporabnik preko aplikacije ali klica API sproži postopek za izračun zaupanja za želenega akterja. Akterjev DID pred klicem funkcije pretvorimo v binarno vrednost \texttt{bytes32} z zgoščevalno funkcijo Keccak-256, ki je značilna za Ethereumov ekosistem. Aplikacija preko odjemalca RPC pokliče funkcijo na pametni pogodbi:
  ...
  \item \textbf{Orakelj zazna novo zahtevo in začne proces izračuna}\newline
    Vsak orakelj neprestano posluša za nove dogodke, ki jih proži pametna pogodba. Ko ta sproži dogodek \texttt{TrustOracleRequested}, orakelj preveri, ali mora obdelati zahtevo za podani \texttt{requestId}.  
    Če je orakelj nastavljen za tovrstne izračune, začne postopek ocenjevanja. Najprej pridobi vse potrebne podatke iz plasti znanja: semantične lastnosti akterja preko poizvedb SPARQL strežniku Fuseki ter pripadajoče preverljive poverilnice. Orakelj tako zagotovi, da bo izračun temeljil na najnovejših, verodostojnih in digitalno podpisanih podatkih.
  ...
  \item \textbf{Orakelj osveži podatke v plasti znanja}\newline
    ...
    \begin{itemize}
      ...
      \item veljavne preverljive poverilnice, ki jih orakelj prebere iz lokalne baze poverilnic.
    \end{itemize}
    Pridobivanje podatkov iz ontologije poteka prek končne točke SPARQL, ki vrne lastnosti subjekta (npr.\ točnost dostav, licenčne statuse, skladnost GMP). Preverljive poverilnice se preverijo z validacijo digitalnega podpisa izdaje. S tem orakelj zagotovi, da izračun temelji na najnovejših in verodostojnih podatkih.
  ...
  \item \textbf{Izvedba izračuna glede na pravila ocenjevalca}\newline
    ...
    \begin{itemize}
      ...
      \item zgostitev pravil (\texttt{policyHash}),
      \item zgostitev uporabljenega VC (\texttt{credentialHash}).
    \end{itemize}

  \item \textbf{Orakelj ustvari poročilo in ga podpiše}\newline
    Orakelj pripravi končno poročilo v JSON obliki, ki vsebuje ključne informacije o izračunu zaupanja: identifikator subjekta, odločitev, oceno, zastavice in pripadajoče povzetke. Preden ga pošlje agregatorju, mora orakelj poročilo kriptografsko podpisati. Podpis se izvede z uporabo metode \texttt{sign\_message}, ki je del knjižnice \texttt{web3.py}. Ta temelji na Ethereumovi shemi EIP-191. Najprej se pripravi deterministična kanonična oblika JSON zapisa, ta pa se nato podpiše z zasebnim ključem oraklja. Podpis omogoča agregatorju, da preveri, ali je poročilo prišlo od zaupanja vrednega oraklja.
  ...
  \item \textbf{Agregator sprejme poročila in izvede preverjanje}\newline
    ...
    \begin{itemize}
      ...
      \item ali se zgostitve pravil in poverilnic ujemajo z lokalnimi podatki.
    \end{itemize}
  ...
  \item \textbf{Agregator izvede konsenz in zapiše končni rezultat}\newline
    ...
    Pametna pogodba preveri, ali je agregator pooblaščen, ali je \texttt{requestId} veljaven in ali zahteva ni pretekla. Če so vsi pogoji izpolnjeni, pogodba zapiše konsenzni rezultat na verigo blokov  in sproži dogodek \texttt{TrustOracleFulfilled}.
...
\begin{enumerate}
  ...
  \item \textbf{Zajem podatkov iz plasti znanja}\newline
    ...
    \begin{itemize}
      \item podatki ontologije prek strežnika Fuseki (poizvedbe SPARQL), ki vključujejo opisna merila akterja,
      \item preverljive poverilnice, ki jih orakelj preveri glede veljavnosti in morebitnega preklica.
    \end{itemize}
    Ti podatki predstavljajo vhodna merila, ki se uporabijo pri izračunu zaupanja.

  \item \textbf{Izvedba lokalnega izračuna zaupanja}\newline
    Orakelj izvede hibridni algoritem ocenjevanja, ki združuje preverjanje pravil ter statističnih meril.
    V tej fazi orakelj pripravi tudi oba ključna povzetka:
    \begin{itemize}
      \item \texttt{policy\_hash}, ki predstavlja zgostitev pravil akterja,
      \item \texttt{credential\_hash}, ki označuje preverljivo poverilnico uporabljeno ob oceni.
    \end{itemize}
  ...
  \item \textbf{Pošiljanje podpisanega poročila agregatorju}\newline
    ...
    \begin{itemize}
      \item \texttt{subject} – 32-bajtni identifikator subjekta oz. zgostitev DID,
    ...
    Podpis se izvede s funkcijo \texttt{sign\_message} iz knjižnice \texttt{web3.py}.  
  ...
  \item \textbf{Preverjanje podpisov in veljavnosti poročil}\newline
    ...
    \begin{itemize}
      \item ali podpis pripada dovoljenemu oraklju,
      \item ali je poročilo unikatno glede na kombinacijo vrednosti \texttt{request\_id} in \texttt{node\_id},
      \item ali se zgostitve pravil in poverilnic ujemajo z njegovimi lokalnimi podatki.
    \end{itemize}
  ...
  \item \textbf{Doseganje kvoruma poročil}\newline
    ...
    Če ta ni dosežen, agregator čaka in nadaljuje zbiranje poročil dokler le ta ni dosežen ali do izteka časa čakanja (\texttt{ttl}).
  ...
  \item \textbf{Agregacija rezultatov znotraj DON}\newline
    ...
    \begin{itemize}
      ...
      \item {FLAG\_VC\_REVOKED (bit 3)} – preverljiva poverilnica (VC), uporabljena pri izračunu, je označena kot preklicana.
    \end{itemize}

    Te bite oraklji nastavijo v funkcijah za izračun ocen. Agregator pri združevanju uporabi prvilo večine: vsak bit v končnem rezultatu je nastavljen, če ga ima vsaj polovica oddanih poročil. Zastavice tako predstavljajo povzetek opozoril, ki jih je zaznalo celotno omrežje orakljev.


  \item \textbf{Zapis konsenznega rezultata v pametno pogodbo}\newline
    Končni agregirani rezultat se na verigo blokov zapiše s funkcijo:
    \begin{quote}\texttt{fulfillTrustReport(requestId, report)}\end{quote}
...
\begin{itemize}
  ...
  \item čas izračuna,
  \item zgostitve pravil in poverilnic,
  \item naslov Ethereum oraklja.
\end{itemize}
...
Kot vidimo na sliki \ref{fig:seq-diagram-read-consensus}, lahko do rezultatov dostopamo prek javne funkcije:
\begin{quote}
...
V tem poglavju predstavimo celovito evalvacijsko analizo razvitega sistema za upravljanje zaupanja. Namen poglavja je prikazati, kako posamezne komponente delujejo skupaj v realističnih scenarijih in kako se sistem obnaša pod vplivom različnih vhodnih podatkov, politik ter sprememb v okolju. Evalvacija je zato zasnovana kot kombinacija eksperimentalne postavitve, podrobnega pregleda algoritmov orakljev in zaporedja scenarijev, ki ponazarjajo ključne procese: izračun zaupanja, agregacijo rezultatov ter odziv sistema na spremembe v podatkih.
...
Sistem sestavlja več vsebnikov Docker, ki so povezani v skupno virtualno omrežje in delujejo z orodjem \texttt{Docker Compose}. V podrazdelku \ref{subsec:algoritmi-orakljev} so opisani posamezni vsebniki in načini ocenjevanja zaupanja za vsak orakelj.

\paragraph{Veriga blokov} Prvi vsebnik vsebuje testno Ethereum omrežje v orodju Anvil. Na njem namestimo pametno pogodbo \texttt{TrustGraph.sol}. Na omrežju takoj dobimo tudi 10 prednastavljenih računov z velikimi količinami testnih kovancev ETH, ki jih oraklji in agregator uporabljajo za plačevanje transakcijskih stroškov. Zato prve račune dodelimo agregatorju in orakljem. Potrebujemo tudi en račun za namestitev pametne pogodbe, katerega dodelimo regulatorju EMA. Ta račun bo imel potem tudi pravico do sprožanja novih izračunov zaupanja.

\paragraph{Baza znanja} V vsebniku Fuseki je naložena domenska ontologija. Ta je dostopna preko končne točke SPARQL, ki jo oraklji uporabljajo za pridobivanje semantičnih lastnosti akterjev. V eksperimentalnem okolju uporabljamo ontologijo, ki si jo vsi oraklji delijo.

\paragraph{Oraklji} Za evalvacijo smo pripravili tri neodvisne oraklje, ki izvajajo svoje politike izračuna zaupanja. Vsak orakelj se izvaja v svojem vsebniku Do\-ck\-er in je konfiguriran z ločeno datoteko, ki določa pravila ocenjevalca, nabor vhodnih podatkov ter težo posameznih kriterijev. Oraklji so implementirani v Pythonu in uporabljajo knjižnice za dostop do verige blokov (web3.py), baze znanja (rdflib, SPARQLWrapper) ter za kriptografske operacije. V podrazdelku \ref{subsec:algoritmi-orakljev} so podrobneje predstavljeni algoritmi izračuna zaupanja za vsak orakelj.

\paragraph{Agregator} Zbiranje poročil posameznih orakljev se izvaja v vsebniku agregatorja. Ta preverja njihove podpise in objavi končno odločitev v pametni pogodbi na verigi. Tudi agregator je implementiran v Pythonu in uporablja podobne knjižnice kot oraklji.

\paragraph{Odjemalska aplikacija} V našem primeru odjemalska aplikacija nastopa kot ukazna vrstica oziroma skripta, s katero sprožimo zahtevo za izračun zaupanja in kasneje preberemo rezultat z verige. V realnem primeru bi bil to lahko npr. spletni vmesnik ali integracija v obstoječi ERP sistem akterja.
...
telemetrijske podatke za izbrane prevoznike. V eksperimentalnem okolju so
ti podatki zapisani v JSON datoteki v naslednji obliki:
...
V poglavju~\ref{sec:trust-management-distributed-systems} smo predstavili različne pristope k upravljanju zaupanja v porazdeljenih sistemih: dokazne modele, priporočilne modele, porazdeljeno ocenjevanje ter dinamično posodabljanje zaupanja. Ti koncepti tvorijo teoretično podlago za zasnovo naših orakljev. V nadaljevanju pokažemo, kako vsak orakelj uporabi drugačen pogled na zaupanje. Za potrebe testiranja smo ustvarili tri oraklje z različnimi algoritmi izračuna zaupanja:

\begin{itemize}
    \item \textbf{Orakelj A} uporablja hibridni pristop, ki kombinira dokazne elemente (licence, digitalna potrdila) z dinamičnimi merili. Podobno, kot je to narejeno v priporočilnih in porazdeljenih modelih zaupanja.
    \item \textbf{Orakelj B} je izrazito \emph{dokazni} – odloča skoraj izključno na podlagi preverljivih poverilnic, podobno kot hierarhični in sistem PGP opisanih v podrazdelku \ref{sub:evidence-trust-models}.
    \item \textbf{Orakelj C} je \emph{telemetrijsko usmerjen} in se naslanja na dinamično posodabljanje zaupanja prek operativnih meril, kar je skladno z modeli, ki večjo težo dajejo nedavnim interakcijam.
\end{itemize}

\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/oracles-sources.png}
  \caption{Viri podatkov za posamezne oraklje v plasti znanja}
  \label{fig:oracle-sources}
\end{figure}

Na sliki~\ref{fig:oracle-sources} je prikazano, iz katerih virov črpajo podatke
posamezni oraklji. Orakelj~A ima hibriden pogled: pri izračunu zaupanja hkrati
upošteva telemetrijo, preverljive poverilnice VC in podatke iz ontologije.
Orakelj~B pri odločanju uporablja samo preverljive poverilnice VC,
medtem ko Orakelj~C izhaja predvsem iz telemetrijskih podatkov. Vsi trije oraklji
ontologijo uporabljajo kot skupni imenik akterjev, iz katerega pridobijo
njihove identifikatorje in osnovne oznake.
...
\end{itemize}
Če subjekt za vse zahtevane kriterije zadošča pogojem, deterministični del vrne odločitev \texttt{PASS}, sicer \texttt{FAIL}. Ta del je najboljši približek \emph{dokaznim modelom zaupanja}, kjer se odločitve sprejemajo na podlagi preverljivih poverilnic in jasno določenih pragov.

\paragraph{Verjetnostni del.}
Verjetnostni del iste kriterije pretvori v številsko verjetnostno oceno v intervalu $[0,1]$, ki jo orakelj kasneje pretvori v osnovne točke med 0 in 10000. Za vsak kriterij se vodi aposteriorni spremenljivki ($\alpha$ in $\beta$) porazdelitve beta $B(\alpha, \beta)$, ki modelira zaupanje za izpolnitev tega kriterija.

Uporaba porazdelitve beta je definirana na intervalu $[0,1]$. V našem parameter $\alpha$ predstavlja število zaželenih oziroma pozitivnih opažanj danega kriterija, parameter $\beta$ pa število negativnih opazovanj. Razmerje $\frac{\alpha}{\alpha+\beta}$ tako predstavlja pričakovano vrednost zaupanja.
Aposteriorna porazdelitev pomeni, da se parametra $\alpha$ in $\beta$ ne obravnavata kot statična, temveč se sproti posodabljata na podlagi novih opazovanj. Vsaka nova interakcija prispeva informacijo o tem, ali je bil kriterij izpolnjen na zaželen način. S tem novejša opazovanja v modelu dobijo večjo težo kot starejša, kar odraža dejansko obnašanje akterjev skozi čas.
...
\begin{equation}
    \alpha = 1 + s_0 \cdot \texttt{obs\_scale}, \qquad
\end{equation}
\begin{equation}
    \beta = 1 + (1 - s_0) \cdot \texttt{obs\_scale},
\end{equation}
kjer je v implementaciji uporabljena utežni faktor $\texttt{obs\_scale} = 9$. Za popolno izpolnjen pogoj ($s_0 \approx 1$) dobimo pričakovano vrednost porazdelitve beta $\mathbb{E}[X] \approx 0{,}91$, kar predstavlja visoko zaupanje.

Pri novih opazovanjih (interakcijah) se aposterior posodobi po principu eksponentno uteženega drsečega povprečja (EWMA) s faktorjem $\gamma \approx 0{,}2$. Če opazovanje prinese zaželenost $s$, se nova parametra $\alpha'$ in $\beta'$ izračunata kot:
\begin{equation}
    \alpha' = (1 - \gamma) \cdot \alpha + \gamma \cdot (1 + s \cdot \texttt{obs\_scale}),
\end{equation}
\begin{equation}
    \beta' = (1 - \gamma) \cdot \beta + \gamma \cdot (1 + (1 - s) \cdot \texttt{obs\_scale}).
\end{equation}
S tem pristopom nove informacije hitreje vplivajo na verjetnostno oceno, starejše pa postopoma izgubljajo težo. To je konceptualno skladno z modeli dinamičnega posodabljanja zaupanja z amortizacijskimi faktorji, kjer novejše interakcije prevladajo nad starimi.

\paragraph{Kombinirana odločitev.}
Za posameznega akterja se končna verjetnostna ocena $\texttt{prob\_score}$ izračuna kot uteženo povprečje srednjih vrednosti beta aposteriorjev ($\frac{\alpha}{\alpha+\beta}$) vseh aktivnih kriterijev. Uteži $w_i$, zapisane v pravilih ocenjevalca (v našem primeru oraklja), so normalizirane tako, da velja $\sum w_i = 1$.

Kombinirana odločitev združuje trda pravila z mehko oceno. Če orakelj uporablja prag $\texttt{prob\_threshold}$, je odločitev:
\[
    \texttt{combined} = \texttt{deterministic} \;\lor\; \left(\texttt{prob\_score} \geq \texttt{prob\_threshold}\right).
\]
Na ta način se trda pragovna pravila (dokazni pogled) kombinirajo z mehko, številsko oceno, ki je bližje priporočilnim in porazdeljenim modelom zaupanja.

V nadaljevanju opišemo konkretne konfiguracije in primere za omenjene oraklje, ki uporabljajo različne pristope, opisane v razdelku~\ref{sec:trust-management-distributed-systems}.
...
\[
    \texttt{prob\_threshold}^{(\text{A})} = 0{,}75.
\]
...
Za distributerja MedLogix v trenutni ontologiji velja \texttt{license=true} in \texttt{GDPVC=true}. Deterministični del zato vrne \texttt{PASS}. Oba kriterija imata visoko zaželenost, zato se Beta posteriorja inicializirata s srednjo vrednostjo približno $0{,}91$. Po normalizaciji uteži (približno $0{,}44$ in $0{,}56$) dobimo verjetnostno oceno:
\[
    \texttt{prob\_score} \approx 0{,}91 \geq 0{,}75.
\]
Kombinirana odločitev je:
\[
    \texttt{combined}^{(\text{A}, \text{MedLogix})} = \texttt{PASS}.
\]

\paragraph{Primer: SkyFreight (transporter)}
Za transporterja SkyFreight sta zabeleženi vrednosti \texttt{punctuality} $= 0{,}90$ in \texttt{tempViolationRate} $= 0{,}08$. Deterministični pogoji niso izpolnjeni, ker $0{,}90 < 0{,}99$ in $0{,}08 > 0{,}05$, zato deterministični del vrne \texttt{FAIL}. Tudi normalizirana zaželenost $s_0$ za oba kriterija je nizka, kar vodi v nizko srednjo vrednost Beta posteriorja in verjetnostno oceno $\texttt{prob\_score} < 0{,}75$. Končna odločitev oraklja je:
\[
    \texttt{combined}^{(\text{A}, \text{SkyFreight})} = \texttt{FAIL}.
\]

\subsubsection*{Orakelj B (dokazni model)}
...
\[
    \texttt{prob\_threshold}^{(\text{B})} = 0{,}8.
\]
...
Ključna značilnost je, da brez ustreznih preverljivih poverilnic odločitev nagiba k \texttt{FAIL}, tudi če so druga operativna merila razmeroma dobra. To odraža močan poudarek na formalnih dokazih in skladnosti.

\paragraph{Primer: MedLogix (distributer)}
Ker ima MedLogix veljavne poverilnice in licenco, deterministični del vrne \texttt{PASS}. Za oba kriterija dobimo srednjo vrednost Beta posteriorja približno $0{,}91$, uteži so po normalizaciji $0{,}67$ in $0{,}33$, zato:
\[
    \texttt{prob\_score} \approx 0{,}91 \geq 0{,}8,
\]
in kombinirana odločitev ostane:
\[
    \texttt{combined}^{(\text{B}, \text{MedLogix})} = \texttt{PASS}.
\]

\paragraph{Primer: HealthChain (transporter)}
Za transporterja HealthChain je v bazi znanja zabeležen \texttt{recallRate} $= 0{,}015$, kar deterministično zadošča pogoju \texttt{hasRecallRate} $\leq 0{,}02$ in daje \texttt{PASS}. Pri verjetnostnem delu pa je zaželenost pri vrednosti blizu zgornje meje nizka (npr.\ $s_0 \approx 0{,}25$), kar vodi v srednjo vrednost Beta posteriorja približno $0{,}30$ in:
\[
    \texttt{prob\_score} \approx 0{,}30 < 0{,}8.
\]
Kombinirana odločitev je zato:
\[
    \texttt{combined}^{(\text{B}, \text{HealthChain})} = \texttt{FAIL},
\]
kar ilustrira strožji, dokazni pristop: deterministični \texttt{PASS} sam po sebi ni zadosten brez visoke verjetnostne ocene.

\subsubsection*{Orakelj C (telemetrijski pogled)}

Orakelj C uporablja telemetrijske podatke med prevozi zdravil (npr. temperatura, vlaga) kot primarni vir informacij. Konceptualno se približa porazdeljenim in dinamičnim modelom zaupanja iz poglavja~\ref{sec:trust-management-distributed-systems}, kjer se zaupanje gradi na osnovi kumulativnih izkušenj in se sproti prilagaja novim dogodkom. Njegov prag za verjetnostno oceno je:
\[
    \texttt{prob\_threshold}^{(\text{C})} = 0{,}7.
\]
...
Za proizvajalca BioPharm sta zabeležena \texttt{tempDev} $= 0{,}08$ in \texttt{GDPVC=true}. Oba pogoja sta deterministično izpolnjena (\texttt{PASS}), zaželenost je visoka in oba kriterija dobita srednjo vrednost posteriorja beta približno $0{,}91$. Verjetnostna ocena je zato:
\[
    \texttt{prob\_score} \approx 0{,}91 \geq 0{,}7,
\]
kombinirana odločitev pa:
\[
    \texttt{combined}^{(\text{C}, \text{BioPharm})} = \texttt{PASS}.
\]

\paragraph{Primer: CanaryLabs (proizvajalec)}
Za proizvajalca CanaryLabs sta zabeležena \texttt{tempDev} $= 0{,}12$ in \texttt{GDPVC=false}. Deterministični del zato vrne \texttt{FAIL}. Ker je temperaturno odstopanje prevelike in ni poverilnice o skladnosti, je tudi verjetnostna ocena nizka ($\texttt{prob\_score} \ll 0{,}7$). Kombinirana odločitev je:
\[
    \texttt{combined}^{(\text{C}, \text{CanaryLabs})} = \texttt{FAIL}.
\]

\medskip

Takšna predstavitev treh orakljev neposredno gradi na modelih iz poglavja~\ref{sec:trust-management-distributed-systems}: Orakelj A predstavlja hibridni semantičen in dinamično podprt pristop, Orakelj B predstavlja strogo dokazno-kriptografski pogled, Orakelj C pa dinamično, na meritvah temeljeno ocenjevanje. V scenarijih, ki sledijo, bomo za izbrani subjekt pokazali, kako različni algoritmi privedejo do različnih, a razložljivih odločitev o zaupanju.

\subsection{Agregacija poročil orakljev}
\label{subsec:agregator-scenariji}

V scenarijih, predstavljenih v nadaljevanju, vedno nastopi enak vzorec: za določenega akterja (npr.\ transportno podjetje ali distributerja) pametna pogodba \texttt{TrustGraph.sol} sproži zahtevo po poročilu o zaupanju, oraklji A, B in C izračunajo lastne ocene in jih pošljejo agregatorju, ta pa iz treh poročil izpelje enotno odločitev, ki jo zapiše na verigo blokov.
...
\begin{itemize}
  \item vsa poročila veljajo za isti subjekt (isti zgoščeni identifikator),
  \item vsa poročila uporabljajo enak povzetek politike (\texttt{policy\_hash}),
  \item povzetek poverilnic (\texttt{credential\_hash}) ni v nasprotju s shrambo poverilnic (če ta obstaja).
\end{itemize}
...
\[
  \text{odločitev} =
  \begin{cases}
    \texttt{true}, & \text{če vsaj dva od treh orakljev poročata \texttt{true}},\\
    \texttt{false}, & \text{sicer}.
  \end{cases}
\]
...
\begin{enumerate}
  \item \emph{posamična poročila} orakljev A, B in C (njihove odločitve, ocene in zastavice),
  \item \emph{agregirano odločitev}, ki jo agregator zapiše na verigo in jo ostali akterji uporabljajo kot referenčno oceno zaupanja za dani subjekt.
\end{enumerate}
Tako je jasno razvidno, kako se različni algoritmi (hibridni, dokazni, telemetrijski) zlivajo v eno, soglasno oceno, ki je dosegljiva vsem
...
\begin{itemize}
  ...
  \item telemetrijski podatki kažejo visoko pravočasnost dostav in sprejemljiva
...
\begin{itemize}
  ...
  \item Orakelj B (dokazni, VC model) preverja skoraj izključno prisotnost veljavne poverilnice (ki je dostopna vsem orakljem) in \texttt{DHL} oceni zelo visoko.
...
\begin{enumerate}
  ...
  \item \textbf{Izračun poročil v orakljih}\newline
        ...
        \begin{itemize}
          \item Orakelj A uporabi politike in semantične podatke ter za prevoznika \texttt{DHL} izračuna negativno odločitev z nizko oceno.
          \item Orakelj B preveri veljavnost poverilnice in subjekt oceni zelo visoko, brez opozoril.
          \item Orakelj C na podlagi telemetrijskih podatkov izračuna pozitivno odločitev in  oceno, ki odraža dobro operativno delovanje.
        \end{itemize}
  ...
  \item \textbf{Agregacija rezultatov}\newline
        ...
        podrazdelka \ref{subsec:agregator-scenariji}: večinsko glasovanje
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{l X c c c}
    ...
    \hline
    Orakelj A & hibridni      & \texttt{FAIL} & 2382 & 0x00 \\
    Orakelj B & dokazni (VC)  & \texttt{PASS} & 9500 & 0x00 \\
    Orakelj C & telemetrija   & \texttt{PASS} & 8879 & 0x00 \\
    Agregator & agregirano    & \texttt{PASS} & 6920 & 0x00 \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{itemize}
  \item \textbf{Orakelj A} vrne negativno odločitev (\texttt{FAIL}) z nizko
  ...
  \item \textbf{Orakelj B} vrne pozitivno odločitev (\texttt{PASS}) z zelo
        ...
        izpolnjeni.
  \item \textbf{Orakelj C} vrne pozitivno odločitev (\texttt{PASS}) z visoko
        oceno $8879$ in brez zastavic. Telemetrijski podatki (pravočasne
...
\begin{itemize}
  \item \textbf{Diskretna odločitev.} Dva od treh orakljev (B in C) poročata
        \texttt{PASS}, eden (A) poroča \texttt{FAIL}. Po večinskem pravilu je
        končna odločitev \texttt{PASS} – subjekt \texttt{DHL} je v agregiranem
  ...
  \item \textbf{Zastavice.} Noben orakelj ne nastavi opozorilnih zastavic,
        ...
        predstavlja pozitiven zapis.
  \item \textbf{Politike in poverilnice.} Vsa tri poročila uporabljajo
        enako vrednost \texttt{credential\_hash}, kar pomeni, da se sklicujejo na isto
...
da je transporter trenutno označen kot zaupanja vreden (\texttt{PASS}) z
...
posamične zapise orakljev A, B in C na verigi ter vidijo, da hibridni pogled
...
kako semantični ter telemetrijski signali lahko pretehtajo pomembnost preverljivih poverilnic. Pri tem posebej poudarimo, da bi v realnem okolju ti podatki prihajali
...
Simuliramo, da se je v opazovanem obdobju povečalo število poznih dostav in odstopanj v senzorskih meritvah. V prototipu to predstavimo kot spremembo zapisa v datoteki s telemetrijskimi podatki:
...
V realnem sistemu tak zapis ne bi bil JSON datoteka, temveč
...
\end{itemize}
Vsak orakelj bi bil odgovoren za svoje poti do takih virov. Nekaterim orakljem so ti podatki ključni, drugi jim dajejo zelo majhno težo. V prototipu te razlike modeliramo z različnimi algoritmi orakljev A, B in C nad istim simuliranim telemetrijskim virom.
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{l X c c c}
    ...
    Vir & Tip algoritma & Odločitev & Številčna ocena & Zastavice \\
    \hline
    Orakelj A & hibridni      & \texttt{FAIL} & 2382 & 0x02 \\
    Orakelj B & dokazni (VC)  & \texttt{PASS} & 9500 & 0x00 \\
    Orakelj C & telemetrija   & \texttt{FAIL} & 6920 & 0x02 \\
    Agregator & agregirano    & \texttt{FAIL} & 6267 & 0x02 \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{itemize}
  \item \textbf{Orakelj A} (hibridni model) ostane negativen (\texttt{FAIL}) z
        ...
        podatkov (npr.\ regulatorne incidente, povzetke revizij, agregirana
        merila kakovosti) in jih semantično povezal v končno oceno.
  \item \textbf{Orakelj B} (dokazni, VC model) se opira predvsem na
        ...
        pozitivna (\texttt{PASS}) z zelo visoko oceno $9500$ in brez
        zastavic (\texttt{0x00}). V realnem scenariju bi ta orakelj tipično
        bral samo iz infrastrukture za digitalna dokazila in ne bi bil neposredno
        povezan z operativno telemetrijo.
  \item \textbf{Orakelj C} (telemetrija) neposredno zazna poslabšanje
        operativnih meril. Pri novih vrednostih
        ...
        \]
        dobimo številčno oceno $6920/10000$. Ker je ocena
        pod pragom in je število alarmov $\geq 2$, orakelj C spremeni
        odločitev v \texttt{FAIL} in nastavi zastavico \texttt{0x02}
...
\begin{itemize}
  \item \textbf{Diskretna odločitev.} Orakelj A in C poročata
        \texttt{FAIL}, Orakelj B poroča \texttt{PASS}. Dva od treh orakljev sta
        negativna, zato je agregirana odločitev \texttt{FAIL}. Z vidika
  ...
  \item \textbf{Številčna ocena.} Ocene treh orakljev so $2382$, $9500$ in
        ...
        približno $6920$), kar odraža vpliv poslabšanih operativnih meril.
  \item \textbf{Zastavice} Oraklja A in C nastavljata zastavico
        ...
        ravni.
  \item \textbf{Politike in poverilnice} Vsa tri poročila uporabljajo enako zgostitev poverilnic \texttt{credential\_hash}, kar pomeni, da se še vedno sklicujejo na isto veljavno preverljivo poverilnico. Agregator pri tem preveri, da poverilnica ni označena kot preklicana. To pomeni, da je sprememba ocene iz \texttt{PASS} (scenarij 1) v \texttt{FAIL} (scenarij 2) posledica izključno poslabšanja operativnih meril in zunanjih podatkov, ne pa spremembe formalnih dokazil.
\end{itemize}

Za ostale akterje v dobavni verigi je rezultat scenarija naslednji: ob
poizvedbi nad \texttt{TrustGraph.sol} za subjekt \texttt{DHL} dobijo informacijo,
da je transporter po novih incidentih označen kot nezaupanja vreden
(\texttt{FAIL}) z agregirano številčno oceno zaupanja približno $6267/10000$ in z zastavico \texttt{0x02}, ki označuje nizko oceno. Primerjava scenarijev~\ref{subsec:scenarij-1} in~\ref{subsec:scenarij-2} jasno pokaže, da je sistem dinamično prilagodil oceno zaupanja na podlagi novih podatkov, pri čemer so semantični in telemetrijski signali pretehtali formalna dokazila, ki jih je predstavljala preverljiva poverilnica.

\section{Varnostna analiza sistema}
\label{sec:varnostna-analiza}

V tem poglavju obravnavamo varnostni vidik ključnih delov razvitega sistema: decentraliziranega omrežja orakljev (DON) in pametne pogodbe. Prav ti dve komponenti skupaj izvajata proces izračuna zaupanja, pripravljata poročila, preverjata njihove podpise in na koncu zapišeta agregirane odločitve v nespremenljivo podatkovno strukturo na verigi.
...
Čeprav je STRIDE široko uporabljen model, se je potrebno zavedati njegovih omejitev. Ne obravnava vprašanj gospodarskih ali ekonomskih spodbud, napadov na semantiko ali zlorab na ravni ontologije, zato te grožnje obravnavamo ločeno kot dopolnilno analizo.

Pri določanju tipa napadalca predpostavimo več ravni zmogljivosti. Prvi scenarij predstavlja zunanjega napadalca, ki ima enaka dovoljenja kot tipični uporabniki verige blokov: lahko kliče javne funkcije pametne pogodbe, spremlja dogodke in poskuša  sprožiti izračune ali preobremeniti pogodbo. Drugi scenarij obravnava orakelj, ki želi škodovati sistemu. Tak orakelj lahko odda napačno poročilo, manipulira z vhodnimi podatki ali poskuša ponarediti podpis. Ker uporabljamo digitalne podpise ECDSA nad deterministično JSON predstavitvijo, tak napadalec ne more ponarediti avtentičnosti, lahko pa poskuša vplivati na izračun s prirejenimi podatki iz ontologije ali preverljivih poverilnic. Tretji scenarij predvideva napadalca, ki cilja na spremembo agregiranja. Ta bi lahko poskušal sprejeti lažna poročila, zlorabiti svoj položaj pri zapisovanju rezultatov ali poskušal reproducirati stare podpise. Ker agregator rekonstruira naslov pošiljatelja iz digitalnega podpisa in preverja časovni žig ter identifikator izvajanja, je zaščiten pred ponarejenimi sporočili in ponavljanjem že obdelanih poročil. Zadnja kategorija so napadi zavrnitve storitve, kjer napadalec poskuša preobremeniti oraklje ali agregator z velikim številom zahtev in tako zmanjšati razpoložljivost izračunov.

Tak model napadalca nam omogoča, da jasno opredelimo, katere komponente se morajo zanašati na kriptografske zaščite (podpisi, zgostitve, preverjanje naslovov), katere so zaščitene z logiko pametne pogodbe (vloge, omejitve klicev) ter kje sistem zahteva dodatne arhitekturne ukrepe za produkcijsko okolje, kot so redundančni agregatorji, nadzor nad ključi ter mehanizmi zaščite pred preobremenitvijo. STRIDE tako ponuja ogrodje, ki ga v nadaljevanju uporabimo za razvrščanje groženj in vrednotenje implementiranih protiukrepov.

\subsection{Analiza groženj za pametno pogodbo}
\label{subsec:groznje-contract}

Pametna pogodba \texttt{TrustGraph.sol} predstavlja edini vir resnice sistema na verigi blokov, saj hrani končne odločitve o zaupanju in posamične prispevke orakljev. Kot smo objasnili v prejšnjem podrazdelku, je pomembno, da sprejema le veljavne agregirane rezultate, pravilno povezuje prispevke z identifikatorji zahtev \texttt{requestId} in zavrača nepooblaščene spremembe stanj. V tabeli~\ref{tab:threat-contract} je zbran pregled glavnih razredov groženj (po modelu STRIDE), tipičnih protiukrepov ter oblik testnega pokrivanja.
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\linewidth}{|X|X|X|}
    ...
    \hline
    Nepooblaščeni klici funkcij za zapis rezultatov & Vloga \texttt{EVALUATOR} oziroma modifikator \texttt{onlyEvaluator}, ki omeji klice na naslov agregatorja & Enotski testi klicev z nedovoljenih naslovov, ki pričakujejo \texttt{revert} \\
    \hline
    Neveljavne spremembe stanja odločitev o zaupanju & Preverjanje parametrov in stanjskih invariant (ujemanje \texttt{requestId}, monotoni časovni žigi, veljavne zastavice) & Testi fuzzing in regresijski testi zaporednih klicev za preverjanje nelogičnih stanj \\
    \hline
    Preobremenitev pogodbe z velikim številom zahtev & Omejitve, kdo lahko sproži nove zahteve, ter preverjanje velikosti in kompleksnosti zapisov, plačilo za klice funkcij pametne pogodbe & Merjenje porabe plina; testi mejnih primerov za funkcije \texttt{requestTrustReport} in \texttt{fulfillTrustReport} \\
    \hline
    Prevelika količina podatkov o subjektih na verigi & Shranjevanje le zgoščenih identifikatorjev in agregiranih ocen & Pregled sheme stanja in testi za nove različice, ki preverjajo, da se na verigo ne dodajajo surovi identifikatorji ali PII \\
    \hline
    Zloraba upravljavskih oziroma administrativnih vlog & Vloge in večpodpisno upravljanje nad kritičnimi konfiguracijskimi funkcijami (npr.\ zamenjava agregatorja) & Enotski testi dodeljevanja, spreminjanja in preklica vlog; zaščite privilegiranih funkcij \\
    \hline
  \end{tabularx}
\end{table}
\end{landscape}

Kot prikazuje tabela~\ref{tab:threat-contract}, je prvi sklop groženj povezan z nepooblaščenimi klici funkcij, ki spreminjajo stanje grafa zaupanja. Tovrstne napade imenujemo slepljenje ali zavajanje (angl. spoofing). V implementaciji funkcije za zapis rezultatov klice omejujemo z vlogo \texttt{EVALUATOR} oziroma modifikatorjem \texttt{onlyEvaluator}, tako da jih lahko kliče le agregator oziroma izrecno pooblaščeni naslovi. Enotski testi implementirani v jeziku Solidity simulirajo klice z drugih naslovov in preverjajo, da pogodba takšne poskuse zavrne s funkcijo \texttt{revert}.

Drugi sklop groženj se nanaša na integriteto stanja pametne pogodbe (angl.\ tampering). Čeprav veriga blokov zagotavlja nespremenljivost zgodovine transakcij, to samo po sebi ne prepreči, da pametna pogodba zaradi neustrezno preverjenih parametrov ali pomanjkljivih logičnih pogojev vnese v svoje stanje nekonsistentne podatke. Do takšnih razmer lahko pride denimo takrat, ko se nov rezultat napačno poveže z drugim subjektom ali ko nova odločitev dobi časovni žig, ki je kronološko starejši od časovnega žiga že obstoječe odločitve za istega subjekta. V tem primeru “računanje časovnega žiga v preteklost” pomeni, da se nova odločitev zabeleži prej kot njej predhodna, saj je njen pripisani časovni žig manjši (starejši). V našem primeru časovni žig nastopa kot kriptografsko zaščiten podatek o času, ki se vključi v zgostitev in podpis poročila ter se zapiše na verigo blokov skupaj z ostalimi parametri. Takšno stanje je semantično nelogično.
Zato so v implementaciji funkcij uvedeni preverjevalni mehanizmi, ki zagotavljajo ohranjanje osnovnih stanjskih invariant (angl.\ state invariants). Med njih spadajo: (i) zahteva, da se vsak novi zapis nanaša na isti identifikator subjekta kot začetni zahtevek, (ii) da je časovni žig (\texttt{asOf}) monoton in nikoli ne nazaduje v preteklost ter (iii) da so meje dovoljenih vrednosti (npr.\ razpon ocene) ustrezno nadzorovane.
Za dodatno zagotovitev pravilnosti smo izvedli kombinacijo enotskih in regresijskih testov. Enotski testi preverjajo posamezne robne primere na ravni funkcij. Regresijski testi pa odkrivajo nove napake v kodi, ki nastanejo z dodajanjem novih funkcij. T. i. testi \textit{fuzz\-ing} avtomatsko generirajo veliko število naključnih kombinacij parametrov (različni \texttt{requestId}, časovni žigi, zastavice in ocene). S tem preverimo, ali bi katera od kombinacij lahko pripeljala pogodbo v nelogično stanje ali sprožila neželene stranske učinke. Regresijski testi pa zagotavljajo, da popravki logike ne uvajajo novih nepravilnosti in da se znane invariante v kasnejših posodobitvah ohranijo.


Tretji sklop se nanaša na napade zavrnitve storitve tipa DoS. Ker so nekatere funkcije pametne pogodbe javno dostopne, lahko velik del zahtev za izračun zaupanja ali nepravilno nastavljeni klici paketov povzročijo, da postane uporaba pogodbe ekonomsko neupravičena. Lahko bi se uvedli stroški za klic vseh funkcij na pametni pogodbi. S tem bi preprečili velike količine zahtevkov. Pri prehodu na produkcijsko verigo bi bilo zagotovo treba omejiti, kdo lahko sproži \texttt{requestTrustReport}, uvesti pragove za velikost paketov ter spremljati porabo stroškov verige blokov, da se pravočasno zazna kršitve.

Četrti sklop pokriva razkritje informacij (angl. information disclosure). Pametna pogodba shranjuje le zgoščene identifikatorje subjektov, agregirano številčno oceno zaupanja ter zastavice, kar sledi načelu minimizacije podatkov. Pri nadaljnjem razvoju je pomembno ohraniti isti pristop tudi pri razširitvah sheme: novi podatki naj bodo vedno agregirani ali zgoščeni. Enotski testi v naši implementaciji preverjajo, da pogodba ne shranjuje neposrednih identifikatorjev podjetij.

Zadnji sklop se nanaša na zlorabo privilegijev (angl.\ elevation of privilege). V produkcijskem okolju bo potrebno uvesti upravljavske funkcije za posodobitev konfiguracije ali migracijo stanja (npr.\ zamenjava agregatorja, posodobitev parametrov politik). Take funkcije je dobro zaščititi z uveljavljenimi vzorci, kot so vloge in večpodpisno upravljanje. Pri večpodpisnem upravljanju noben posamezen skrbnik ne more sam izvesti kritične operacije, temveč je za odobritev potrebna kombinacija podpisov več neodvisnih udeležencev. Na ta način zmanjšamo tveganje zlorabe enega podpisa. Upravljavske funkcije je smiselno podpreti z enotskimi testi, ki preverjajo pravilno dodeljevanje, rotacijo in preklic vlog ter varnostne meje med njimi. Tako bi lahko na primer regulator predlagal spremembo agregatorja, ki bi jo morali potrditi vsi člani sveta za upravljanje sistema, preden bi postala aktivna.


\subsection{Analiza groženj za decentralizirano omrežje orakljev}
\label{subsec:groznje-don}

Mreža orakljev in agregator skupaj tvorita decentralizirano omrežje, ki je odgovorno za izračun in agregacijo ocen zaupanja. Pretok podatkov poteka tako, da pametna pogodba izda dogodek \texttt{TrustOracleRequested} za dani \texttt{requestId} in subjekt, oraklji preberejo dogodek, iz zunanjih podatkov izračunajo oceno zaupanja in pripravijo podpisano poročilo. Agregator sprejme poročila prek končne točke \texttt{/reports}, preveri podpise, preveri priložene poverilnice, izvede agregacijo in rezultat zapiše v pametno pogodbo. Tabela~\ref{tab:threat-don} povzema glavne grožnje po modelu STRIDE, tipične protiukrepe ter predvideno testno pokritje na ravni orakljev in agregatorja.
...
\begin{table}[ht]
  ...
  \begin{tabularx}{\linewidth}{|X|X|X|}
    ...
    Spreminjanje vsebine poročil med prenosom ali v agregatorju 
      & Podpis predstavitve JSON, preverjanje zgostitev in zavrnitev pri neskladju
      & Enotski testi serializacije ter preverjanja podpisov in zgostitev \\
    \hline
    Orakelj zanika, da je oddal določeno poročilo 
      & Shranjevanje zgostitev podpisanih poročil in obnova naslova iz podpisa 
      & Testi obnove naslova iz podpisa in ujemanja z zapisanim \texttt{node\_id} ter revizijske sledi \\
    \hline
    Prekomerno evidentiranje identitet subjektov ali poverilnic 
      & Zgostitve identifikatorjev v dnevnikih 
...
Prva skupina groženj za DON je povezana z istovetnostjo orakljev (spoofing). Agregator pri prejemu poročila kriptografsko obnovi naslov iz podpisa in ga preveri s seznamom dovoljenih vozlišč. Poročila z neznanih naslovov ali napačnimi podpisi zavrne. Ker podpis vključuje tudi \texttt{nonce} oziroma \texttt{run-id} in časovni žig, lahko agregator zazna in zavrne ponovno predvajanje starega sporočila in s tem prepreči napade ponovitve. Integracijski testi za HTTP vmesnik preverijo, da so spremenjena ali napačno podpisana poročila zavrnjena z ustrezno napako.

Pri napadih s spreminjanjem podatkov ščitimo predvsem integriteto vsebine poročil. Ker je podpisan JSON celotnega poročila, agregator zazna vsako spremembo vsebine med prenosom ali vmesnim shranjevanjem. Za produkcijsko okolje je smiselno dodati revizijsko sled (na primer zapis zgostitev sprejetih poročil), kar omogoča naknadno preverjanje skladnosti med prejetimi poročili in zapisi na verigi. Enotski testi pri tem preverijo, da serializacija poročila v kanonično obliko vedno vrne enak rezultat in da vsaka sprememba vsebine povzroči neuspeh preverjanja podpisa.

Grožnja z zanikanjem sodelovanja je pomembna z vidika transparentnosti: orakelj bi lahko poskušal zanikati, da je oddal poročilo za določenega partnerja. Ker imamo digitalni podpis poročila in, ker lahko iz verige blokov ponovno oblikujemo poročilo oraklja v kanonično obliko JSON, lahko s klicem funkcije \texttt{recover\_message} iz knjižnice \texttt{web3.py} dobimo naslov oraklja, ki je poročilo podpisal. S tem lahko kadarkoli neodvisno preverimo ali je orakelj res oddal določeno poročilo.

Del zasnove DON je tudi preverjanje preverljivih poverilnic (VC), ki spremljajo poročila. Vsak orakelj poleg ocene zaupanja priloži VC, ki dokazuje njegovo pooblastilo ali lastnosti subjekta. Agregator pred sprejemom poročila preveri podpis VC, status preklica, časovno veljavnost in skladnost sheme z vnaprej definirano politiko. Poročila z neveljavnimi ali preklicanimi poverilnicami so zavrnjena in se nikoli ne zapišejo na verigo. To zmanjša tveganje, da bi se na grafe zaupanja zapisali ponarejeni ali zastareli dokazi.

Informacijsko razkritje v omrežju orakljev se najpogosteje zgodi prek dnevniških zapisov. V prototipu oraklji in agregator že uporabljajo zgoščene identifikatorje subjektov, saj se DID pred zapisom v dnevnik pretvori v vrednost \texttt{bytes32}. Kljub temu je pri nadaljnjem razvoju treba paziti, da v dnevnikih ne ostanejo neposredni naslovi URI ali vsebine poverilnic. Priporočljivo je dosledno uvesti preverjanje dnevnikov (npr. izpis le skrajšanih zgostitev in anonimnih oznak namesto poslovnih imen) ter z enotnimi testi preverjati, da dnevniki ne vsebujejo občutljivih podatkov.

Napadi zavrnitve storitve (DoS) ciljajo na razpoložljivost omrežja. Ker v prototipu omejevanje hitrosti ni povsod implementirano, so oraklji in agregator teoretično dovzetni za preobremenitev z veliko količino zahtev. V produkcijski rabi bi morali definirati omejitev dostopa na nivoju omrežja in zagotoviti redundanco vozlišč, tako da izpad posameznega oraklja ali agregatorja ne poruši sistema in da se promet enakomerno porazdeli.

Zadnji sklop groženj se nanaša na privilegije agregatorja. Trenutni model predvideva en osrednji agregator, ki ima pooblastilo za zapis agregiranih odločitev v pametno pogodbo. Če bi bil ta agregator kompromitiran, bi lahko v imenu legitimnih orakljev pošiljal napačne podatke ali spreminjal rezultat agregacije, preden se ta zapiše na verigo. Pri razširitvi v produkcijo bi bilo smiselno razmisliti o več agregatorjih, ki bi morali doseči soglasje, ali o prenosu dela agregacijske logike v pametno pogodbo samo, tako da posamezno vozlišče ne bi moglo samostojno manipulirati z rezultati. Simulacije različnih nastavitev kvoruma in scenarijev kompromitiranih vozlišč lahko pomagajo oceniti, kako odporen bi bil tak sistem na zajetje ali okvaro posameznih komponent. Rešitev bi lahko bila tudi zapis ocen orakljev neposredno na verigo, čeprav bi to zahtevalo dodatne arhitekturne prilagoditve in povečane stroške.

\subsection{Povzetek tveganj in omejitve prototipa}
\label{subsec:povzetek-don}

V analizi smo se osredotočili na del sistema, ki deluje na verigi blokov in v mreži orakljev. Implementacija že vključuje več ključnih varnostnih mehanizmov: podpisana poročila orakljev, preverjanje naslovov v agregatorju, uporabo časovnih žigov za zaščito pred napadi ponovitve, osnovno preverjanje preverljivih poverilnic, shranjevanje le zgoščenih identifikatorjev in agregiranih ocen na verigi ter jasno ločitev med logiko na verigi in izven nje.

Kljub temu za uporabo v produkcijskem okolju ostaja odprtih več pomembnih vprašanj: registracija in upravljanje identitet orakljev ter agregatorjev na nivoju pametne pogodbe, varno upravljanje z zasebnimi ključi (shramba, spremembe dovoljenj, odziv ob kompromitaciji), odpornost na napade zavrnitve storitve v DON (redundantni oraklji, več agregatorjev, mehanizmi soglasja) ter obsežnejše testiranje pametne pogodbe za preprečevanje nelogičnih stanj. Varnostna analiza tako ne služi le kot opis trenutnega stanja, temveč tudi kot usmeritev, katera področja bi bilo treba prioritetno nadgraditi pri prenosu rešitve v realno, produkcijsko okolje.
...
Trenutna implementacija deluje kot laboratorijska postavitev, v kateri deluje omejeno število orakljev, en agregator in ena instanca pametne pogodbe na testnem omrežju verige blokov, vse pa je vezano na poenostavljeno infrastrukturo Docker. Takšen prototip je primeren za demonstracijo koncepta in ponovljivih scenarijev, ni pa neposredno prenosljiv v okolje, kjer bi morali upoštevati zahtevnejše omejitve glede razpoložljivosti, upravljanja identitet, nadzora nad konfiguracijo in dolgoročne vzdržnosti.
...
Pomemben del prehoda v produkcijo je formalizacija upravljanja identitet in poverilnic akterjev. Za plast preverljivih poverilnic bi bila naravna izbira uporaba evropske infrastrukture EBSI, ki že definira standardizirane formate VC in DID ter infrastrukturo za preverjanje in preklic. V takem scenariju bi oraklji in akterji v dobavni verigi nastopali z DID, veriga blokov in DON pa bi se zanašala na EBSI kot na zunanji vir resnice za status poverilnic. Vse, kar bi se zapisalo na verigo, bi bili le povzetki teh VC in politik, medtem ko bi se polna vsebina in osebni podatki obdelovali v okviru EBSI in povezanih sistemov.

Za samo infrastrukturo DON bi bilo smiselno raziskati uporabo obstoječe rešitve za decentralizirana omrežja orakljev, kot je Chainlink. Ta platforma že nudi vzorce za varno izvajanje orakljev v heterogenem omrežju, mehanizme za nadzor nad zanesljivostjo vozlišč, podpisane povratne klice in zaščito pred posameznimi kompromitiranimi vozlišči. Namesto lastne implementacije bi lahko mehanizem ocenjevanja zaupanja v prihodnje prevedli v Chainlinkove naloge, kjer bi nadzorni sklop (na primer regulator ali konzorcij akterjev) definiral, kateri oraklji sodelujejo v posamezni nalogi, s kakšnimi utežmi in pod katerimi pogoji.

Na ravni pametne pogodbe bi prehod v produkcijo zahteval utrditev mehanizmov upravljanja in nadgradnje. Ključno je, da pogodba jasno loči vloge (regulator, akterji, tehnični skrbniki) in omeji njihova pooblastila z dobro preizkušenimi vzorci, kot so večpodpisne denarnice (angl. Multi-Sig Wallet) in formalno definirani postopki nadgradnje. Vsak poseg v konfiguracijo, na primer dodajanje ali odstranjevanje oraklja, zamenjava agregatorja ali sprememba pragov zaupanja, bi moral biti transparenten, sledljiv in odobren s strani vnaprej definiranega deleža udeležencev.

Poleg identitet in upravljanja vlog bi bilo treba v produkcijskem okolju bistveno več pozornosti nameniti varnemu upravljanju zasebnih ključev ter razpoložljivosti celotne arhitekture. Ključi orakljev in agregatorjev bi morali biti shranjeni v varnih shrambah ter jasnimi postopki ob zaznani kompromitaciji. Infrastrukturo orakljev bi bilo treba postaviti v ponovljivem okolju, z nadzorovanimi posodobitvami, spremljanjem izpada in mehanizmi za avtomatsko preusmeritev prometa v primeru okvare.

Pot od trenutnega prototipa do produkcijskega sistema bi v praksi potekala v več korakih. Najprej bi bilo smiselno utrditi že implementirane varnostne mehanizme na ravni pametne pogodbe in agregatorja, dodati formalizirano upravljanje vlog ter razširiti testno pokritost. Sledila bi faza razširitve DON z več neodvisnimi oraklji in morda več agregatorji, kjer bi se v pilotnem okolju preizkusile različne konfiguracije kvoruma in algoritmi agregacije. V naslednjem koraku bi se sistem integriral z realno infrastrukturo preverljivih poverilnic (EBSI) in z izbranimi operativnimi sistemi akterjev v dobavni verigi, ob tem pa bi se v sodelovanju z regulatorji definirali formalni postopki uporabe rezultatov zaupanja v odločanju o odpošiljanju in licenciranju. Po uspešnem pilotnem obdobju bi sledil popoln prehod v produkcijsko okolje, z ustrezno dokumentacijo, usposabljanjem uporabnikov in vzpostavitvijo postopkov za dolgoročno vzdrževanje in nadgrajevanje sistema.

\section{Operativni in regulativni vidiki}
\label{sec:operativni-regulativni-vidiki}

Če želimo mehanizem zaupanja prenesti iz eksperimentalnega okolja v dejansko farmacevtsko dobavno verigo, ga moramo umestiti v obstoječe procese kakovosti in regulative. Ocena iz DON ne bi nadomestila regulatorne odgovornosti, temveč bi delovala kot dodatni, standardiziran vhod v postopke kvalifikacije in periodičnega preverjanja partnerjev (proizvajalcev, distributerjev, transporterjev) ter odločanja o odpošiljanju serij. V praksi bi bila integrirana v obstoječe informacijske sisteme (npr.\ sistem za upravljanje dobaviteljev ali modul za izdajo serije) prek vmesnika API: aplikacija bi ob potrebi sprožila poizvedbo, prejela strukturiran odgovor (vključujoč odločitev, oceno, časovni žig) in ga vključila v revizijsko sled ter dokumentacijo kakovosti. Z vidika upravljanja bi bil DON najverjetneje vzpostavljen kot skupna infrastruktura, nad katero bi imel nadzor regulator ali konzorcij regulatorjev in industrije, ki bi skrbel za referenčne politike, pravila za vstop in izključitev orakljev ter revizijo njihovih algoritmov.

Regulativno in z vidika varovanja podatkov je ključna ločitev med plastjo na verigi in izven verige. Surovi podatki (osebni, poslovno občutljivi) ostajajo v sistemih podvrženih GDPR \cite{gdpr2016}, na verigo pa se zapisujejo le zgoščeni identifikatorji subjektov, politik in poverilnic ter agregirane ocene in zastavice. Veriga tako služi predvsem kot objekt integritete in neizbrisljiv dnevnik: v primeru spora lahko regulator ali akter neodvisno preveri, da objavljena ocena in pripadajoče poverilnice od trenutka objave niso bile spremenjene. Za produkcijsko rabo bi moral biti tudi sam mehanizem DON obravnavan kot validiran računalniški sistem z jasno opredeljenimi kritičnimi funkcijami, kontroliranim upravljanjem sprememb ter periodičnim pregledom algoritmov in pravil agregacije.

\section{Širši potencial in vizija uporabe sistema}
\label{sec:sirsi-potencial-vizija}

Čeprav je bila rešitev v tej nalogi konkretizirana na farmacevtski dobavni verigi, je osnovni vzorec precej širši. V jedru ne upravljamo zaupanja v zdravila, temveč v akterje, ki si izmenjujejo podatke in prevzemajo odgovornost v porazdeljenem sistemu. Tukaj imamo v mislih organizacije z različnimi vlogami, pogosto nasprotujočimi si interesi in heterogenimi podatkovnimi viri, katere potrebujejo jasne in preverljive zapise o tem, komu in pod kakšnimi pogoji zaupajo. Enak vzorec se pojavi v drugih dobavnih verigah: pri dobavni verigi hrane, elektronskih komponent, oskrbi z energenti, recikliranju materialov ipd. Povsod, kjer so prisotne tri lastnosti: (i) več neodvisnih organizacij, (ii) različni in pogosto nezdružljivi viri podatkov ter (iii) potreba po transparentnem in neodvisno preverljivem zapisu rezultatov.
...
Zanimiva smer nadaljnjega razvoja je tudi preizkus zasnove v drugih sektorjih. Pametna mesta, energetika, logistika, kritična infrastruktura in omrežja IoT predstavljajo naravne kandidate, kjer podobno kot v farmacevtskem sektorju obstaja potreba po transparentnem, razložljivem in preverljivem mehanizmu zaupanja. Razširitev arhitekture na te domene bi omogočila oceno univerzalnosti predstavljenega koncepta in njegovo prilagodljivost različnim operativnim zahtevam. S tem bi lahko nastal generičen okvir za vzpostavitev digitalnih ekosistemov zaupanja, ki bi prispevali k varnejšemu in bolj transparentnemu razvoju porazdeljenih sistemov v digitalni družbi.
