...
\begin{table}[ht]
  ...
  \begin{tabularx}{\linewidth}{|X|X|X|}
    ...
    \hline
    Preobremenitev pogodbe z velikim številom zahtev & Omejitve, kdo lahko sproži nove zahteve, ter preverjanje velikosti in kompleksnosti zapisov, zaračunavanje za klice na pametno pogodbo & Merjenje porabe plina in testi mejnih primerov za funkcije \texttt{requestTrustReport} in \texttt{fulfillTrustReport} \\
    \hline
...
Regulativno in z vidika varovanja podatkov je ključna ločitev med plastjo na verigi in izven verige. Surovi podatki (osebni, poslovno občutljivi) ostajajo v sistemih podvrženih GDPR \cite{gdpr2016}, na verigo pa se zapisujejo le zgoščeni identifikatorji subjektov, politik in poverilnic ter agregirane ocene in zastavice. Veriga tako služi predvsem kot objekt integritete in neizbrisljiv dnevnik: v primeru spora lahko regulator ali audit neodvisno preveri, da objavljena ocena in pripadajoče poverilnice od trenutka objave niso bile spremenjene. Za produkcijsko rabo bi moral biti tudi sam mehanizem DON obravnavan kot validiran računalniški sistem z jasno opredeljenimi kritičnimi funkcijami, kontroliranim upravljanjem sprememb ter periodičnim pregledom algoritmov in pravil agregacije.
