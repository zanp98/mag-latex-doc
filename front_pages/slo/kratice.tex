...
\begin{table}[ht]
  ...
  >{\raggedright\arraybackslash}X}
    ...
    \textbf{Akter} &
    Udeleženec sistema, ki sodeluje v procesih izmenjave podatkov in sprejemanja odločitev. Akter lahko nastopa kot ocenjevalec (zahteva oceno) ali kot ocenjevani subjekt. \\ \hline
    \textbf{Entiteta} &
    Splošen pojem za subjekt ali objekt, ki nastopa v obravnavanem okolju. V kontekstu naloge so entitete praviloma akterji, izraz pa se uporablja tudi kadar govorimo splošno (npr.\ o udeležencih ali objektih v sistemu) brez vezave na konkretno vlogo. \\ \hline
    ...
    Strukturiran in kriptografsko podpisan zapis, ki javni ključ poveže z identiteto določenega subjekta izdan s strani zaupanja vrednega izdajatelja. Prejemniku omogoča preverjanje, komu pripada dani javni ključ. \\
...
\begin{table}[ht]
  ...
  >{\raggedright\arraybackslash}X}
    ...
    \textbf{Porazdeljeni sistem} &
    Sistem, sestavljen iz več medsebojno povezanih komponent (vozlišč), ki komunicirajo prek omrežja in skupaj izvajajo funkcije sistema. \\ \hline
    \textbf{Proof of Stake} &
    Konsenzni mehanizem, kjer vpliv udeleženca na predlaganje in potrjevanje blokov temelji na količini vloženih (z zaklenitvijo zavarovanih) sredstev v omrežju, pri čemer ekonomski vložek deluje kot spodbuda za pošteno vedenje in varovalka pred napadi. \\ \hline
    \textbf{Proof of Work} &
