...
%
\vspace{1mm}
\noindent Spodaj podpisani Žan Pižmoht, vpisna številka 63170233, avtor zaključnega dela z naslovom:

\vspace{1mm}
\noindent\emph{Sistem za zagotavljanje zaupanja v dobavni verigi zdravil z uporabo verige blokov}\hspace{5mm}(angl. \emph{Trust System in Pharmaceutical Supply Chain Using Blockchain})

\vspace{1mm}
\begin{center}IZJAVLJAM\end{center}
\begin{enumerate}
\setlength\itemsep{0mm}
\item da sem pisno zaključno delo študija izdelal samostojno pod mentorstvom prof.~dr. Vlada Stankovskega in somentorstvom doc.~dr.\ Petra Kochovskega;
...
\vspace{2mm}
\noindent V Ljubljani, dne 24. novembra 2025 \hfill Podpis študenta/-ke:
